...
You’ll find the detailed steps for running the application in the xref:tutorial:project-setup.adoc#run-app[Running Application from IDE] section of the Tutorial.
