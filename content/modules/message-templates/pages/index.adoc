...
This add-on allows you to create and customize message templates that combine static content with dynamic parameters. You can design templates in the visual HTML designer, which provides a wide range of HTML elements. The visual HTML editor offers a comprehensive toolkit for template design, making it easy to craft engaging and professional messages.
