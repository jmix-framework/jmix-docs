...
If the ready-made assistant is not what you need — because the conversation belongs to your own domain, or because the chat interface has to be yours — the xref:ai-chat:index.adoc[AI Chat Components] add-on provides the components to build one from: a complete chat, the transcript and composer it is assembled from, and a code block.
