...
When the conversation belongs to your own domain, or the chat interface has to be yours, build your own from the xref:ai-chat:index.adoc[AI Chat Components] add-on. It provides a complete chat, the message list and message input it is assembled from, and a code block.
