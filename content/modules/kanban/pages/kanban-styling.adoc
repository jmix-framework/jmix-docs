...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/kanban-styling" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
Компонент `kanban` поддерживает пользовательские JavaScript-рендереры для стилизации и отображения карточек задач и столбцов. Дополнительную информацию смотрите в разделе xref:flow-ui:vc/components/kanban.adoc#renderers[Рендереры].
