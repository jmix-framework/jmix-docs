...
<div class="jmix-ui-live-demo-container">
    <a href="http://demo.jmix.ru/ui-samples/sample/kanban-column-actions" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="http://demo.jmix.ru/ui-samples/sample/kanban-styling" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
