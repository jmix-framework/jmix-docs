...
Чтобы сопоставить атрибут сущности с полем карточки Kanban, вам нужно добавить элемент xref:flow-ui:vc/components/kanban.adoc#propertiesMapping[propertiesMapping] в компонент `kanban`.
