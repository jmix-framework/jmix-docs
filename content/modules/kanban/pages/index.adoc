...
Компонент xref:flow-ui:vc/components/kanban.adoc[kanban] визуализирует рабочий процесс проекта: задачи представлены карточками, а этапы — колонками. Это позволяет быстро оценить прогресс. Дополнение основано на JavaScript-библиотеке https://htmlelements.com/demos/kanban/overview/[Smart Kanban^].

image::overview-embedded-kanban.png[align="center",width="890"]

Ключевые возможности дополнения Kanban:

* *Визуальная kanban-доска*: полностью настраиваемую доску можно встроить в любой экран Jmix.
* *Управление задачами*: Управление задачами на доске, включая назначение их пользователям, установку сроков и приоритетов.
* *Управление этапами*: Создание и управление этапами (xref:flow-ui:vc/components/kanban.adoc#column[колонками]) на доске, представляющими различные фазы вашего рабочего процесса.
