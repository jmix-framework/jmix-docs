...
The second reason is that indirect: by executing the business logic that we want to test. This business logic itself performs some operation against the database. Let's look at an example for both of those scenarios:
