...
You can open views from the main view, by xref:flow-ui:actions/standard-actions.adoc[standard actions] when working with list and detail entity views or programmatically from another view.
