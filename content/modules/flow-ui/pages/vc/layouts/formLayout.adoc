...
image::visual-components/components/form-layout-basic-1.png[align="center", width="659"]

When the layout width is smaller, it automatically adjusts to a single column.

image::visual-components/components/form-layout-basic-2.png[align="center", width="650"]
...
image::visual-components/components/form-layout-columns.png[align="center", width="780"]
...
image::visual-components/components/form-layout.png[align="center", width="659"]
