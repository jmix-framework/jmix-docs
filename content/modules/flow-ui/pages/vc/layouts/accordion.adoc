...
Each `accordionPanel` has a summary and a content area to put other components or layouts. The summary remains visible, even when the panel is collapsed. The component allows you to provide longer summaries, as opposed to xref:vc/layouts/tabSheet.adoc[].
...
Use xref:vc/common-attributes.adoc#themeNames[themeNames] attribute to set an `accordionPanel` theme.
...
See https://vaadin.com/docs/v25/components/accordion[Vaadin Docs^] for more information.
