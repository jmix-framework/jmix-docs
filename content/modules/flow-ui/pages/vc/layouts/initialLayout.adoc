...
`initialLayout` 组件是在 xref:flow-ui:views.adoc#standard-main-view[主视图] 中还没有打开任何视图时显示的布局。如果需要在打开其他视图之前显示某些默认内容（如 logo 或仪表板）时，可以使用该组件。
...
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/main/MainView.java[tags=initialLayout]
----
