...
The `initialLayout` component is a layout that will be displayed when no views are opened in the xref:flow-ui:views/view-classes.adoc#standard-main-view[main view]. This component can be useful when you need to show some default content, such as a logo or dashboard, before any other views are opened.
