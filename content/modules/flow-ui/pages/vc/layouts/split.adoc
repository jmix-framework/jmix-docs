...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v25/components/split-layout/#theme-variants" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
Дополнительную информацию смотрите в https://vaadin.com/docs/v25/components/split-layout[документации Vaadin^].
