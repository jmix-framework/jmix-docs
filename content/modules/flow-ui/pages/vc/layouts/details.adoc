...
Sets a different theme to change the component's appearance. See <<theme-variants,Theme Variants>> for the available built-in variants.
...
See the https://vaadin.com/docs/v25/components/details[Vaadin Docs^] for more information.
