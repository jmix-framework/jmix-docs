...
|xref:vc/html-components/fieldset.adoc[]
|`fieldset`
...
Большинство HTML-компонентов можно связать с сущностями модели данных с помощью XML-атрибутов xref:vc/common-attributes.adoc#dataContainer[dataContainer] и xref:vc/common-attributes.adoc#property[property].
