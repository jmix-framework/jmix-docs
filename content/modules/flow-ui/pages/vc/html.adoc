...
Most HTML components can be bound to your data model entities using the xref:vc/common-attributes.adoc#dataContainer[dataContainer] and xref:vc/common-attributes.adoc#property[property] XML attributes.