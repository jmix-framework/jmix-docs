...
[TIP]
====
Чтобы добавить форматтер для компонента в Jmix Studio, выберите компонент в XML-дескрипторе экрана или на панели иерархии *Jmix UI* и нажмите кнопку *Add* на панели инспектора *Jmix UI*.
