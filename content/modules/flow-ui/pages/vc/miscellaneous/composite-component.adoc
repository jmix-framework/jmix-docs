...
When working on real projects, it's often necessary to create composite UI components. Jmix Flow UI greatly simplifies the process of creating unique UI elements specific to a project. Composite components allow developers to bundle multiple UI elements together, making it easier to manage and reuse them across various screens. These components can also host other components, enabling the creation and maintenance of complex UI structures efficiently.

Composite components not only display UI elements but can also perform various tasks like loading data and connecting to data containers. This capability enhances the component's functionality, enabling it to interact with data sources and provide dynamic content to the user. By using composite components, developers can create and maintain consistent UI designs throughout their projects, saving time and effort by reducing code duplication and promoting efficient development practices.
...
This entity is used in various other entities in our project, such as `Employee`, `Compositeer`, `Manager`, etc. For example:
...
=== Java Descriptor for the Composite Component
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponent.java[tags=address-component]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponent.java[tags=init-content]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponent.java[tags=assign-data-to-components]
----
...
[source,xml,indent=0]
----
include::example$onboarding/src/main/resources/com/company/onboarding/view/component/compositecomponent/address-component.xsd[tags=]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponentLoader.java[tags=address-component-loader]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponentLoader.java[tags=create-component]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/AddressComponentLoader.java[tags=load-component]
----

=== Registering the Composite Component
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/CompositeComponentConfiguration.java[tags=]
----
...
[source,xml,indent=0]
----
include::example$onboarding/src/main/resources/com/company/onboarding/view/component/compositecomponent/composite-component.xml[tags=]
----

Like any other component, our composite component can be declared not only declaratively in an XML screen descriptor but also programmatically in its controller. Here is an example of how this can be done.

[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/compositecomponent/CompositeComponentView.java[tags=screen-controller]
----