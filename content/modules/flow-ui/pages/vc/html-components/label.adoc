...
The `label` component is applicable to native HTML components and can also serve as an alternative for the xref:vc/common-attributes.adoc#label[label] attribute that is present in the majority of UI components in Jmix.
