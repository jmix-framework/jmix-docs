...
В этом разделе демонстрируется, как создать компонент, используя https://vaadin.com/docs/v25/flow/create-ui/element-api[Element API^] и единственный DOM-элемент.
