...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/composite-component" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++
...
https://vaadin.com/docs/v25/components/custom-field[CustomField^] 是一个基类，可以将多个组件包装成一个单一输入控件。提供标准输入字段功能，例如标签、帮助文本和验证。可以用来创建自定义输入组件。
