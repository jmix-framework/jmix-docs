...
https://vaadin.com/docs/v25/components/custom-field[CustomField^] is a base class for wrapping multiple components into a single field. It provides standard input field features such as label, helper, and validation. Use it to create custom input components.
