...
You can create https://vaadin.com/docs/v25/flow/create-ui/web-components/introduction-to-webcomponents[Web Components^] from scratch based on https://polymer-library.polymer-project.org/[Polymer 3^] or https://lit.dev/[Lit^] libraries. After a JavaScript Web Component is implemented, you can create a Java API for it.
