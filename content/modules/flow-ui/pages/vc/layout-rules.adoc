...
For simple styling, you can use https://vaadin.com/docs/v25/styling/lumo/utility-classes[Lumo Utility Classes^] provided by Vaadin. *Lumo Utility Classes* are predefined CSS class names and stylesheets. They can be used to style HTML elements and layouts without having to write CSS.
