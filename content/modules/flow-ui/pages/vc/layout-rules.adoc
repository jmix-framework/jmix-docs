...
Для простой стилизации можно использовать https://vaadin.com/docs/v25/styling/lumo/utility-classes[утилитные классы Lumo^], предоставляемые Vaadin. Они представляют собой предопределенные классы CSS, решающие типовые задачи.
