...
The https://javadoc.io/doc/com.vaadin/vaadin-platform-javadoc/latest/com/vaadin/flow/theme/lumo/LumoUtility.html[LumoUtility] Java class contains `String` constants for all utility classes. They're divided into nested category classes, such as `LumoUtility.Margin`.
