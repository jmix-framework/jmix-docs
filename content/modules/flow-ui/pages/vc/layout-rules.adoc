...
对于简单的样式设置，可以使用 Vaadin 提供的 https://vaadin.com/docs/v25/styling/lumo/utility-classes[Lumo Utility Classes（辅助类）^]。*Lumo 辅助类* 是预定义的 CSS 类名和样式表。可用于设置 HTML 元素和布局的样式，而无需编写 CSS。
