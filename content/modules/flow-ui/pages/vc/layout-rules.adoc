...
For simple styling *Lumo Utility Classes* can be used. *Lumo Utility Classes* are predefined CSS class names and stylesheets. They can be used to style HTML elements and layouts without having to write CSS.
...
image::layout-rules/LumoUtility.png[]
