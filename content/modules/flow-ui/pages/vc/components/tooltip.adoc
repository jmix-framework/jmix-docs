...
An example of defining a xref:flow-ui:vc/components/textField.adoc[textField] with a `tooltip`:
...
The `tooltip` element does not define handlers. Focus and hover events are handled by the component to which the tooltip is attached.

== See Also

* https://vaadin.com/docs/v25/components/tooltip[Vaadin Tooltip documentation^]
