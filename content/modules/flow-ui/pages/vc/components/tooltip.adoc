...
TIP: To add a nested `tooltip` element in Jmix Studio, select the component in the screen descriptor XML or in the *Jmix UI* hierarchy panel and click on the xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Tooltip* button in the *Jmix UI* inspector panel.
