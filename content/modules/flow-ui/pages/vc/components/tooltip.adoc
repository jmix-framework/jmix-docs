...
Set the `manual` property for a `tooltip`.
...
Set the `opened` property for a `tooltip`.
...
Set the `position` property for a `tooltip`.
...
Set the plain text content of a `tooltip`.
