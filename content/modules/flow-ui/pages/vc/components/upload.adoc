...
Our Samples demo application includes an https://demo.jmix.io/ui-samples/sample/upload[example^] that utilizes a `MultiFileMemoryBuffer` to manage multiple files in `com.vaadin.flow.component.upload.SucceededEvent`.
