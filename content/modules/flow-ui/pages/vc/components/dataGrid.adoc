...
Renders a custom component in each cell.
...
Use this renderer for interactive or rich cell content such as checkboxes, images, or buttons. This subsection shows how to apply the shared renderer mechanism to a `dataGrid` column. For general usage patterns and performance considerations, see xref:flow-ui:vc/miscellaneous/renderers.adoc#component-renderer[Component Renderer].
