...
|Elements
|<<actions,actions>> - <<columns,columns>> - contextMenu
|===
...
[cols="1h,5,1", grid=none, frame=none]
|===
|*Name*
|*Description*
|*Default*
...
[cols="1h,6", grid=none, frame=none]
|===
|*Name*
|*Description*
|[[CellFocusEvent]]CellFocusEvent
...
[TIP]
====
To add an element to the component click the xref:studio:screen-designer.adoc#add-column[Add] button in the *Jmix UI* inspector panel.
====

[[columns]]
=== Columns

The `columns` element specifies attributes and behaviors to apply to all the nested `column` elements.
...
.Show `columns` attributes
[%collapsible]
====
[cols="1,5,1", grid=none, frame=none]
|===
|*Name*
|*Description*
|*Default*
...
[%collapsible]
====
// The following are attributes specific to `column`:
...
|`false`
|[[textAlign]]`textAlign`
|Specifies the alignment of the text with the following possible values: `START`, `CENTER`, `END`.
|`START`
|[[visible]]`visible`
