...
`passwordField` component defines a field for entering passwords. Characters typed into this field are masked by default. Using this field users can set or change a password or enter it on the login page.
...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/passwordfield/PasswordFieldView.java[tags=validator]
----
