...
image::visual-components/components/password-field-basic.png[align="center", width="183"]
...
Смотрите https://vaadin.com/docs/v25/components/password-field[документацию Vaadin^] для получения дополнительной информации.
