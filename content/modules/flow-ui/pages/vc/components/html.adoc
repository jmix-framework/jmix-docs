...
Jmix includes a set of xref:vc/html.adoc[HTML components] for standard HTML elements. If no suitable component included, or you want to include native HTML directly, use the `html` component. It can render HTML provided as a string, CDATA, or file.
