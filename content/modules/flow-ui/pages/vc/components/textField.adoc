...
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v23/components/text-field/#autoselect" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
https://vaadin.com/docs/v23/components/text-field[Vaadin 文档^]。
