...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/radio-button-group-theme-variant" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++
...
https://vaadin.com/docs/v25/components/radio-button[Vaadin 文档^]
