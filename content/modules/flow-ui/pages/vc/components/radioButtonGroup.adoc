...
A `radioButtonGroup` can include <<fragment-renderer,fragmentRenderer>> and xref:vc/components/tooltip.adoc[tooltip] as its nested elements.

== See Also

* https://vaadin.com/docs/v25/components/radio-button[Vaadin Radio Button documentation^]
