...
Следующий пример показывает варианты ориентации.
...
[source,xml,indent=0]
----
include::example$/onboarding/src/main/resources/com/company/onboarding/view/component/radiobuttongroup/radio-button-group-view.xml[tags=theme-orientation]
----
====
...
Дополнительную информацию смотрите в {vaadin-docs}/components/radio-button[документации Vaadin^].
