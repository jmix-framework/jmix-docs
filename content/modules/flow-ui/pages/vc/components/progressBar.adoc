...
In indeterminate mode `progressBar` cycles repeatedly along the length of the bar without showing a specific progress value. This mode can be used for a process which doesn't share its progress value.
