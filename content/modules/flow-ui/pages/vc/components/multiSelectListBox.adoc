...
Для создания списка элементов используйте атрибуты xref:vc/components/entityComboBox.adoc#itemsContainer[itemsContainer] или xref:vc/components/comboBox.adoc#itemsEnum[itemsEnum]:
...
Смотрите https://vaadin.com/docs/v25/components/list-box#multi[документацию Vaadin^] для получения дополнительной информации.