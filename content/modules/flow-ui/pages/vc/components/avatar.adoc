...
По умолчанию компонент имеет стандартный средний размер. Доступны четыре варианта размера и один вариант поверхности:
...
Дополнительную информацию смотрите в https://vaadin.com/docs/latest/components/avatar[документации Vaadin^].
