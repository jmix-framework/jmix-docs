...
По умолчанию элементы располагаются горизонтально. Чтобы изменить расположение на вертикальное, используйте атрибут xref:vc/common-attributes.adoc#themeNames[themeNames]:
