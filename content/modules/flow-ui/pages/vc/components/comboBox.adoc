...
Defines the enumeration class for creation a list of options. The drop-down list will show localized names of enum values; the component’s value will be an enum value.
...
See the https://vaadin.com/docs/v23/components/combo-box[Vaadin Docs^] for more information.