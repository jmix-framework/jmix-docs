...
Defines the enumeration class for creating a list of options. The drop-down list will show localized names of enum values; the component’s value will be an enum value.
