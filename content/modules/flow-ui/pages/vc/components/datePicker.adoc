...
To restrict the input to a specific date range, specify a minimum and maximum value using the <<max, max>> and <<min,min>> attributes. This can also be done in the screen controller:
