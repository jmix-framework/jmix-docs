...
The default value of this list is specified in the xref:flow-ui:ui-properties.adoc#jmix.flowui.component.pagination-items-per-page-items[jmix.flowui.component.pagination-items-per-page-items] property.
...
[NOTE]
====
The maximum fetch size for all entities is defined by xref:flow-ui:ui-properties.adoc#jmix.flowui.default-max-fetch-size[jmix.flowui.default-max-fetch-size] UI property. Its default value is 10000. A particular entity may have different maximum fetch size, set with xref:flow-ui:ui-properties.adoc#jmix.flowui.entity-max-fetch-size[jmix.flowui.entity-max-fetch-size].
====
