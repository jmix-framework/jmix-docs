...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/value-picker-dataaware" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
A `valuePicker` can include <<actions,actions>>, xref:vc/miscellaneous/formatter.adoc[formatter], xref:vc/miscellaneous/prefix-suffix.adoc[prefix], xref:vc/miscellaneous/prefix-suffix.adoc[suffix], xref:vc/components/tooltip.adoc[tooltip], and <<validation,validator>> as its nested elements.
