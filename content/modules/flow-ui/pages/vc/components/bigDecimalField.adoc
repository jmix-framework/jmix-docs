...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/big-decimal-field-dataaware" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
A `bigDecimalField` can include xref:vc/miscellaneous/prefix-suffix.adoc[prefix], xref:vc/miscellaneous/prefix-suffix.adoc[suffix], xref:vc/components/tooltip.adoc[tooltip], and xref:vc/miscellaneous/validator.adoc[validator] as its nested elements.
