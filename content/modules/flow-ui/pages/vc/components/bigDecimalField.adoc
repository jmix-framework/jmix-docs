...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.io/ui-samples/sample/big-decimal-field-theme-variant" class="live-demo-btn" target="_blank">在线示例</a>
</div>
++++

使用 xref:vc/common-attributes.adoc#themeNames[themeNames] 属性可以自定义组件的外观，有 5 个不同的选项：
...
参阅 `textField` xref:vc/components/textField.adoc#themeVariants[样式版本] 部分了解更多。
