...
如需创建关联数据的 `multiSelectComboBoxPicker`，请使用 xref:vc/common-attributes.adoc#dataContainer[dataContainer] 和 xref:vc/common-attributes.adoc#property[property] 属性。`itemsContainer` 属性用于创建选项列表。
