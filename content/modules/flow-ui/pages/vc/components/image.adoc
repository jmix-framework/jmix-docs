...
`image` is designed to display images from different sources. The component can be bound to a xref:flow-ui:vc/common-attributes.adoc#dataContainer[data container] or configured programmatically.
...
To display the image provided by this attribute, specify it in the component. For that, specify the xref:flow-ui:vc/common-attributes.adoc#dataContainer[data container] and xref:flow-ui:vc/common-attributes.adoc#property[property] attributes.

[source, xml, indent=0]
----
include::example$onboarding/src/main/resources/com/company/onboarding/view/component/image/image-view.xml[tags=data;instance;facets;layout;fileRefImage]
----
...
[source,xml,indent=0]
----
include::example$onboarding/src/main/resources/com/company/onboarding/view/component/image/image-view.xml[tags=static-resource]
----
+
* In Java:
+
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/imageresources/ImageResourcesView.java[tags=image-static]
----
...
[source, xml, indent=0]
----
include::example$onboarding/src/main/resources/com/company/onboarding/view/component/image/image-view.xml[tags=url-resource]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/imageresources/ImageResourcesView.java[tags=image-url]
----
...
[source,java,indent=0]
----
include::example$onboarding/src/main/java/com/company/onboarding/view/component/imageresources/ImageResourcesView.java[tags=image-stream]
----
