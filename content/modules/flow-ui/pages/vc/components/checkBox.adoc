...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/v23/components/checkbox/#indeterminate" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
...
See the https://vaadin.com/docs/v23/components/checkbox[Vaadin Docs^] for more information.