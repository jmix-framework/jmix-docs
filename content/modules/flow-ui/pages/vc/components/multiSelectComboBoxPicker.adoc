...
Чтобы создать `multiSelectComboBoxPicker`, связанный с данными, используйте атрибуты xref:vc/common-attributes.adoc#dataContainer[dataContainer] и xref:vc/common-attributes.adoc#property[property]. Атрибут xref:vc/components/entityComboBox.adoc#itemsContainer[itemsContainer] используется для создания списка элементов. Следующий пример создает `multiSelectComboBoxPicker`, поддерживающий работу с данными.
