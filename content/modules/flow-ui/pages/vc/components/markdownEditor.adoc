...
Use the xref:vc/common-attributes.adoc#themeNames[themeNames] attribute to control helper text placement and toolbar alignment.

The component is functional without a theme and integrates with both Lumo and Aura. The theme variants below are supported in Lumo and Aura.
...
[source,xml,indent=0]
----
include::example$/onboarding/src/main/resources/com/company/onboarding/view/component/markdowneditor/markdown-editor-view.xml[tags=markdown-editor-theme-names]
----
