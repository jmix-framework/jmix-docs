...
image::visual-components/components/integer-field-data-binding.png[align="center", width="209"]
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://vaadin.com/docs/latest/components/number-field#minimum-and-maximum-value" class="vaadin-docs-btn" target="_blank">Vaadin</a>
</div>
++++
