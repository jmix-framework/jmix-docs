...
应用程序中的默认时间日期格式是由 xref:data-model:datatype.adoc#localized-format-strings[本地格式字符串] 定义。如需使用不同格式，请在消息包添加自定义格式字符串。
...
https://vaadin.com/docs/v25/components/date-time-picker[Vaadin 文档^]
