= pivotTable
:page-aliases: pivot-table:pivottable-component.adoc
:table-caption!:

[NOTE.addon-component]
====
Для работы компонента требуется дополнение xref:pivot-table:index.adoc#installation[Pivot Table].
====
...
`pivotTable` позволяет представить данные в виде настраиваемой сводной таблицы.
...
Объявите пространство имен `pvttbl` в XML-дескрипторе экрана:

[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottable/pivottable-view.xml[tags=xmlns]
----
...
Затем добавьте `pivotTable` и свяжите его с xref:flow-ui:data/data-containers.adoc[контейнером данных]:
...
Чтобы настроить компонент, укажите контейнер данных и отображаемые свойства. Объявите данные компонента следующим образом:

[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottable/pivottable-view.xml[tags=data]
----

В следующем примере показана базовая конфигурация `pivotTable`:

[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottable/pivottable-view.xml[tags=simple]
----

image::pivot-table:pivot-table-basics.png[align="center", width="748"]

[CAUTION]
====
Компонент `pivotTable` построен на JavaScript-библиотеке https://jquery.com/[jQuery^]. Если другие интегрированные компоненты тоже используют `jQuery`, разные версии библиотеки могут конфликтовать. Чтобы предотвратить конфликты, используйте подход https://api.jquery.com/jQuery.noConflict/#jQuery-noConflict-removeAll[jQuery.noConflict()^].

В UI Samples доступен https://demo.jmix.ru/ui-samples/sample/custom-component-js-library[пример^] использования `jQuery.noConflict()`.
====
...
----
include::pivot-table:example$/pivottable-ex1/src/main/java/com/company/ex1/model/Shape.java[tags=shape]
----
====
...
[source,java,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/java/com/company/ex1/model/ShapeListPivotTableItems.java[tags=shape-list]
----
====
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottablecustomdatabinding/pivot-table-custom-data-binding-view.xml[tags=pivot-table]
----
====
...
[source,java,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/java/com/company/ex1/view/pivottablecustomdatabinding/PivotTableCustomDataBindingView.java[tags=create-items]
----
====
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/pivot-table-ui" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
image::pivot-table:pivot-table-ui-mode.png[align="center", width="1157"]
...
image::pivot-table:auto-sort-unused-properties.png[align="center", width="646"]
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottablerenderer/pivot-table-renderer-view.xml[tags=renderers]
----
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/pivottableaggregator/pivot-table-aggregator-view.xml[tags=pivotTable;aggregations]
----
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/withdefaultaggregation/with-default-aggregation-view.xml[tags=pivotTable;aggregations-default;aggregationProperties]
----
<1> Атрибут <<aggregations-selected,selected>> устанавливает функцию агрегации `SUM` по умолчанию в выпадающем списке.
...
image::pivot-table:pivot-table-aggregation-defaults.png[align="center", width="275"]
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/withdefaultaggregation/with-default-aggregation-view.xml[tags=pivotTable;pivotTable2;hiddenFromAggregations]
----
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/withaggregation/with-aggregation-view.xml[tags=pivotTable]
----
...
|Локализованное сообщение `Нет данных`
|[[menuLimit]]menuLimit
...
|`85` (вертикально, если суммарная длина названий атрибутов превышает это значение)
|===
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/pivot-table-derived-properties" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
[source,xml,indent=0]
----
include::pivot-table:example$/pivottable-ex1/src/main/resources/com/company/ex1/view/derivedproperty/derived-property-view.xml[tags=simple]
----
...
Элемент `rendererOptions` позволяет настроить параметры выбранного рендерера. Настройка доступна только для двух типов рендереров:
...
++++
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/pivot-table-sorter-function" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
