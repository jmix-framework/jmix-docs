...
См. также https://vaadin.com/docs/v25/flow/routing/exceptions[документацию Vaadin^] по обработке исключений навигации.