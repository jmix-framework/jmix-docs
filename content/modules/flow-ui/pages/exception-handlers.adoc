...
Dimensions of the default exception handler dialog can be customized using CSS variables in your xref:flow-ui:themes/themes.adoc#application-theme-files[application theme] CSS file. For example:
...
See also https://vaadin.com/docs/v25/flow/routing/exceptions[Vaadin documentation^] for more information about navigation exceptions.
