...
`StandardMainView` is a root application view which is opened after login. It contains the https://vaadin.com/docs/v25/components/app-layout[AppLayout^] component with the main menu.
