...
`StandardMainView` - это корневой экран приложения, который открывается после входа пользователя в систему. Он содержит компонент  https://vaadin.com/docs/v25/components/app-layout[AppLayout^] с главным меню.
