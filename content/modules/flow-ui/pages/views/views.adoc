...
The diagram below shows the process of opening and closing a standard view:

.Opening and closing a standard view
image::views/standard-view-lifecycle.svg[align="center"]

The diagram below shows the process of opening a detail view, either through navigation or as a dialog:

.Opening a detail view for entity editing
image::views/open-detail-view.svg[align="center"]


The diagram below shows the process of saving changes and closing a view:
