...
:page-aliases: using-fragments.adoc
...
NOTE: Если фрагмент подписан на xref:fragments/fragments.adoc#fragment-autowiring[событие] хост-экрана, то фрагмент должен быть создан и добавлен в экран перед тем, как это событие будет вызвано.
