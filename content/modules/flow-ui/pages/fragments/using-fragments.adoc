...
// todo: link
In this section, we explain how to define and use fragments. See also Fragment Events for how to handle fragment lifecycle events.
...
====
// todo: fix path
To add a parameter in Jmix Studio, select `fragment` in the view descriptor XML or in the *Component Hierarchy* panel and click on the xref:studio:view-designer.adoc#component-inspector-add-button[Add]*->Properties->Controller Property* button in the *Component Inspector* panel.
====
