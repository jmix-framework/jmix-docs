...
NOTE: If a fragment subscribes to a host view xref:fragments/fragments.adoc#fragment-autowiring[event], a fragment must be created and added to the view before this event is triggered.
