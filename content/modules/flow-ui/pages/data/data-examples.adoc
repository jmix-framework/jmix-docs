...
In the example below, we create an editor view with the same data and visual components as defined in the previous section using only Java code without any XML descriptor.
