...
----
<1> - `create` and `edit` actions are xref:actions/standard-actions.adoc[standard actions]. Their properties and behaviour are defined by their types.
...
image::actions/declarative-actions-1.png[align="center"]
