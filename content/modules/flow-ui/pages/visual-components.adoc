...
Studio allows you to build views in a visual designer with a preview, components hierarchy and properties panels. When you click the *Add Component* button, Studio shows a palette of available components:
