...
<3> Using https://vaadin.com/docs/latest/flow/create-ui/creating-components/mixins[Using Vaadin Mixin Interfaces^] to provide common APIs and default behavior for sets of functionalities found in most Web Components.
...
image::creating-components/theme-toggle-usage.gif[align="center", width="325"]