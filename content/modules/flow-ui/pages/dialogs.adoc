...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/dialogssample/DialogsSampleView.java[tags=inject-dialogs;inputDialog-standard-parameters]
----
...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/dialogssample/DialogsSampleView.java[tags=inject-dialogs;inputDialog-custom-parameters]
----
...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/dialogssample/DialogsSampleView.java[tags=inject-dialogs;inputDialog-custom-validator]
----
...
<3> Throw a validation error if no parameters are entered.