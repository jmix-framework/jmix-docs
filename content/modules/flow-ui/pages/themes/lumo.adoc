...
. The Vaadin Lumo stylesheet applies the standard Lumo theme.
. The xref:themes/themes.adoc#application-theme-files[Jmix Lumo stylesheet] provides styles for Jmix components and standard Jmix views.
...
NOTE: Lumo utility classes are intended mainly for HTML elements, layout components, and custom UI structures. They cannot directly style elements inside a component's shadow DOM. Use component style properties or documented selectors for component internals. See xref:themes/styling-ui-components.adoc#component-parts[Styling Component Parts] for examples.
