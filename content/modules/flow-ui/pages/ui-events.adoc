...
Чтобы отослать события компонентам UI, включая открытые xref:views/views.adoc[экраны], необходимо использовать бин `UiEventPublisher` фреймворка.
...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/view/main/MainView.java[tags=import-subscribe;import-event-listener;import-onboarding-status-changed-event;import-span;import-list-menu;class-declaration;init-event;!init-initialLayout;!get-menu-item;!new-menu-item;ui-event-listener]
----
...
[source,java,indent=0]
----
include::example$/onboarding/src/main/java/com/company/onboarding/listener/UserStepEventListener.java[tags=import-component;import-data-manager;import-ui-event-publisher;import-event-listener;import-entity-changed-event;import-user;import-user-step;import-id;ui-event-publisher-1;ui-event-publisher-2]
----
