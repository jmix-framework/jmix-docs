...
To deliver application events to UI components including opened xref:views.adoc[views] you need to use the `UiEventPublisher` bean provided by the framework.
