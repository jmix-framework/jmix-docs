...
Defines a view to be opened after login inside the xref:flow-ui:views.adoc#standard-main-view[main view]. For example:
...
The identifier of a view to be used as the xref:flow-ui:views.adoc#standard-main-view[main page] of the application.
