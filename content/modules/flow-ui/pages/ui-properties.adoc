...
Задает экран, который будет открыт после входа в систему внутри xref:flow-ui:views.adoc#standard-main-view[главного экрана]. Например:
...
Идентификатор экрана, который будет использоваться в качестве xref:flow-ui:views.adoc#standard-main-view[главной страницы] приложения.
