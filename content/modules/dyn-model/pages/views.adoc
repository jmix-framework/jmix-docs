...
A view declaration for a dynamic entity can also place the view in the application menu by adding a `menuItem` object. This saves you from editing the menu separately: when the model is applied, the menu item appears alongside the generated view. The `menuItem` in the snippet above demonstrates the typical fields:
