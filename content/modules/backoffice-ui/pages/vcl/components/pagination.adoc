...
As opposed to xref:vcl/components/simple-pagination.adoc[SimplePagination], `Pagination` cannot be used inside the `Table`, `DataGrid`, and other list components.
