...
+
The example of creating a custom action for an `entityPicker`:
+
[source,java,indent=0]
----
...
// TODO: добавить пример и ссылку на новый раздел (см тикет № 190)
//[[formatter]]
//=== Formatter

// TODO: добавить пример и ссылку на новый раздел (см тикет № 189)
//[[validator]]
//=== Validator
