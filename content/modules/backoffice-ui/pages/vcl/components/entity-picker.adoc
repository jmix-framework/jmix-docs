...
[source, xml,indent=0]
----
include::example$/ex1/src/main/resources/ui/ex1/screen/address/address-edit.xml[tags=fieldEditable]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/ui/ex1/screen/address/AddressEdit.java[tags=field-value-change]
----
