...
If you are not satisfied with the xref:vcl/components/entity-combo-box.adoc#predefined-validators[predefined] validators, adds your own validator instance:
