...
`SimplePagination` is a component used to load data by pages. As opposed to xref:vcl/components/pagination.adoc[Pagination], you can use it inside the `Table`, `DataGrid`, and other list components.
