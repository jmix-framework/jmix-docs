...
xref:vcl/components/text-field.adoc#text-change-listener[`TextChangeListener`] and xref:vcl/components/text-field.adoc#value-change-listener[`ValueChangeListener`] work in the same way as in the `xref:vcl/components/text-field.adoc#listeners[Text Field]`.
