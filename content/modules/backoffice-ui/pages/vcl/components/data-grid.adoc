...
The `column` element of `DataGrid` has a child `numberRenderer` element with optional `nullRepresentation` attribute and required `format` string attribute.
...
The `column` element of `DataGrid` has a child `localDateTimeRenderer` element with optional `nullRepresentation` attribute and required `format` string attribute:
...
The `column` element of `DataGrid` has a child `localDateRenderer` element with optional `nullRepresentation` attribute and required `format` string attribute:
...
The `column` element of `DataGrid` has a child `dateRenderer` element with optional `nullRepresentation` attribute and required `format` string attribute:
