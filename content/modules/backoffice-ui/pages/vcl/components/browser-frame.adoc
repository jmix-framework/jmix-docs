...
`BrowserFrame` allows you to display embedded content: web pages, PDF files, and images.
...
To display some content, you need to define `resource` element with one of the following elements:
