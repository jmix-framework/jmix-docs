...
`RichTextArea` allows you to enter or edit formatted text. The toolbar provides all basic editing functionalities. The text content of `RichTextArea` is represented in HTML format.
