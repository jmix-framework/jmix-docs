...
`RichTextArea` allows users to enter or edit formatted text. The toolbar provides all basic editing functionalities. The value of the `RichTextArea` is a `String` represented in HTML format.
