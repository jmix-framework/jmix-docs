...
You can put any xref:vcl/components.adoc[component] or xref:vcl/containers.adoc[container] in the tab element. But to demonstrate a simple `accordion`, let's add labels to each tab:
