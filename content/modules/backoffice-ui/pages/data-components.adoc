...
* xref:backoffice-ui:data/data-loaders.adoc[Loaders] load data from the middle tier to containers.
* xref:backoffice-ui:data/data-context.adoc[DataContext] tracks changes in entities and saves changed instances back to the middle tier upon request.
