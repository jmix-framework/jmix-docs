...
* `messagesPack` − a default message pack for the screen. It is used to obtain localized messages in the controller using `getMessage()` method and in the XML descriptor using a message key without specifying the pack.
