...
Also, you can use *Login screen with branding image* template in Studio wizard to create a new login screen. After creating, the idetifier of the newly created screen will be set in the xref:backoffice-ui:app-properties.adoc#jmix.ui.loginScreenId[jmix.ui.loginScreenId] property. 
...
* *Main screen with side menu*. Allows you to expand and collapse the side menu using the *Collapse* button located in the lower-left corner.
+
By default, the framework provides a main screen with a side menu.
+
* *Main screen with top menu*. Allows you to locate a menu bar on the top of your application. You can create this screen from a template using Studio wizard. After creating, the idetifier of the newly created screen will be set in the xref:backoffice-ui:app-properties.adoc#jmix.ui.mainScreenId[jmix.ui.mainScreenId] property.
