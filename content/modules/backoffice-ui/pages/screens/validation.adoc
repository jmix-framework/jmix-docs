...
+
You can adjust the dialog type using xref:backoffice-ui:app-properties.adoc#jmix.ui.screen.use-save-confirmation[jmix.ui.screen.use-save-confirmation] application property.
