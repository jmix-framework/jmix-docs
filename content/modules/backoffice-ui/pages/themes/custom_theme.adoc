...
To compile an extended theme, define the following dependencies for the `themes` configuration in `build.gradle`:
...
[source,properties,indent=0]
----
jmix.ui.theme = hover-dark
jmix.ui.themeConfig = ui/ex1/theme/hover-dark-theme.properties
----

. Restart the application. Now the user will see the application in the *Hover-dark* theme on the first login:
+
