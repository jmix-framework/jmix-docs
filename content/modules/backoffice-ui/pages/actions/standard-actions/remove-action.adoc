...
`RemoveAction` is a xref:actions/standart-actions.adoc#list-actions[list action] designed to remove xref:data-model:entities.adoc[entity] instances from a data container in UI and from the database.
