...
`RefreshAction` is a xref:actions/standart-actions.adoc#list-actions[list action]  designed to reload the data container which is used by the table or tree component.
