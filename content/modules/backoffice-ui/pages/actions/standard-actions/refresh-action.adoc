...
`RefreshAction` is a xref:actions/standart-actions.adoc#list-actions[list action]  designed to reload the data container used by the table or tree component.
