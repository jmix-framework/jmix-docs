...
For example, declare an action with the `sayHello` identifier and a caption from the screen’s message pack. This action is bound to a button, which caption will be taken from the action’s caption.
