...
To declare the `WebdavDocumentUploadField` component in a screen XML descriptor, first add a namespace with the `\http://jmix.io/schema/webdav/ui` URI to it. Then use this namespace with the component element, 示例：
