...
Add the `lastModifiedBy` column to `webdavDocumentWrappersDataGrid`:
...
Add the `lastModifiedDate` column to `webdavDocumentWrappersDataGrid`:
...
The *Last modified by* column displays the author of the latest modifications to the WebDAV file, while the *Last modified date* column shows the date of the latest modifications to the WebDAV file.
