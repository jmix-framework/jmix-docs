...
* Use the xref:webdav:ui-components.adoc#webdav-document-upload-field[webdavDocumentUpload] component on the WebDAV document wrapper detail view to upload the WebDAV document into the system.
...
Inject the `UiComponents` object into the controller class:
