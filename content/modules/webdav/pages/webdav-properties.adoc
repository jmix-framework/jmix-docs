...
This property allows you to change the schedule of xref:webdav:configuration.adoc#webdav-document-versions-cleaning-job[WebdavDocumentVersionsCleaningJob] as http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html[cron^] expression if necessary.
...
This property allows you to change the schedule of xref:webdav:configuration.adoc#expired-lock-cleaning-job[ExpiredLockCleaningJob] as http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html[cron^] expression if necessary.
...
Defines the default interval in milliseconds for a document xref:webdav:webdav-documents.adoc#lock-unlock[locking].
