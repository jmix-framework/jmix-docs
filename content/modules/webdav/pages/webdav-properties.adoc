...
该属性支持以 http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html[cron^] 表达式修改 xref:webdav:configuration.adoc#webdav-document-versions-cleaning-job[WebdavDocumentVersionsCleaningJob] 的调度计划。
...
该属性支持以 http://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html[cron^] 表达式修改 xref:webdav:configuration.adoc#expired-lock-cleaning-job[ExpiredLockCleaningJob] 的调度计划。
...
定义文档 xref:webdav:webdav-documents.adoc#lock-unlock[锁定] 的默认间隔，单位为毫秒。
...
该属性可以禁用 xref:webdav:configuration.adoc#webdav-document-versions-cleaning-job[WebdavDocumentVersionsCleaningJob] 任务创建和计划的默认配置。
...
该属性可以禁用 xref:webdav:configuration.adoc#expired-lock-cleaning-job[ExpiredLockCleaningJob] 任务创建和计划的默认配置。
