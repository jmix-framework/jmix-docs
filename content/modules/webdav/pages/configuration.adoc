...
To use Quartz Job Scheduler for periodic invocation of maintenance tasks, include Quartz in your project as described in the xref:ROOT:quartz-setup.adoc[] section.
...
To change the job schedule, use the xref:webdav:configuration.adoc#jmix-webdav-expired-lock-cleaning-cron[jmix.webdav.expiredLockCleaningCron] property.
...
To change the job schedule, use the xref:webdav:configuration.adoc#jmix-webdav-document-versions-cleaning-cron[jmix.webdav.documentVersionsCleaningCron] property.
