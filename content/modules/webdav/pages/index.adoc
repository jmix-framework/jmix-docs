...
Desktop applications use basic authentication for server connections via WebDAV, so you have to setup HTTPS for your web application. Refer to the xref:configuration.adoc#https[Configuring HTTPS] section for guidance on configuring HTTPS on localhost for development purposes.
