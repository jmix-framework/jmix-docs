...
To override the default conflict resolution policy, declare a bean of the `DefaultMergePolicy` type in a Spring configuration class. The bean should return the needed merge policy. 示例：
