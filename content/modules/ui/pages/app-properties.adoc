...
Using `false` is a good idea when you completely control the menu entries that are rendered. It allows you to easily remove, change and reorder menu entries from add-ons.
