...
The value passed to the `withHtmlSanitizer()` method overrides the value of global xref:app-properties.adoc#jmix.ui.component.html-sanitizer-enabled[jmix.ui.component.html-sanitizer-enabled] configuration property.
