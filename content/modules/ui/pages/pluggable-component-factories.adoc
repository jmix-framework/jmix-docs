...
----
include::example$/ex1/src/main/java/ui/ex1/entity/SalesComponentGenerationStrategy.java[]
----
<1> Check the specific field of the `Order` entity
<2> Check that the component is created for the `Form` component
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/ui/ex1/entity/ColorComponentGenerationStrategy.java[]
----
