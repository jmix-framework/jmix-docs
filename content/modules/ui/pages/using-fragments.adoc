...
[TIP]
====
如需在 Jmix Studio 中添加参数，可以在界面 XML 或者 *Component Hierarchy* 面板中选择 `fragment`，然后点击 *Component Inspector* 面板的 xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Properties->Controller Property* 按钮。
====
