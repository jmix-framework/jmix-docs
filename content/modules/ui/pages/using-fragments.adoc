...
[TIP]
====
To add a parameter in Jmix Studio, select `fragment` in the screen descriptor XML or in the *Component Hierarchy* panel and click on the xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Properties->Controller Property* button in the *Component Inspector* panel.
====
