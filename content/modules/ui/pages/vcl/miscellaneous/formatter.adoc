...
[TIP]
====
To add a nested `formatter` element in Jmix Studio, select the component, or it nested element in the screen descriptor XML or in the *Jmix UI* hierarchy panel and click on the xref:studio:screen-designer.adoc#component-inspector-add-button[Add] button in the *Jmix UI* inspector panel.
====
