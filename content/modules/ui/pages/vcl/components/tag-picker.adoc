...
`TagPicker` has the following handlers and events described in xref:vcl/components/tag-field.adoc#handlers[TagField]:

[[tag-caption-provider]]
=== TagCaptionProvider

See xref:vcl/components/tag-field.adoc#tag-caption-provider[TagCaptionProvider].

[[tag-click-listener]]
=== TagClickListener

See xref:vcl/components/tag-field.adoc#tag-click-listener[TagClickListener].

[[tag-comparator]]
=== TagComparator

See xref:vcl/components/tag-field.adoc#tag-comparator[TagComparator].

[[tag-style-provider]]
=== TagStyleProvider

See xref:vcl/components/tag-field.adoc#tag-style-provider[TagStyleProvider].

[[validator]]
=== Validator

See xref:vcl/components/tag-field.adoc#validator[Validator].
