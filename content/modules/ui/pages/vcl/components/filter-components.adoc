...
[TIP]
====
如需在 Jmix Studio 中添加 `propertyFilter`，可以在界面 XML 或者 *Component Hierarchy* 面板中选择 `Filter` 组件，然后点击 *Component Inspector* 面板的 xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Conditions->PropertyFilter* 按钮。
====
...
[TIP]
====
如需在 Jmix Studio 中添加 `jpqlFilter`，可以在界面 XML 或者 *Component Hierarchy* 面板中选择 `Filter` 组件，然后点击 *Component Inspector* 面板的 xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Conditions->JPQLFilter* 按钮。
====
...
[TIP]
====
如需在 Jmix Studio 中添加 `groupFilter`，可以在界面 XML 或者 *Component Hierarchy* 面板中选择 `Filter` 组件，然后点击 *Component Inspector* 面板的 xref:studio:screen-designer.adoc#component-inspector-add-button[Add]*->Conditions->GroupFilter* 按钮。
====
