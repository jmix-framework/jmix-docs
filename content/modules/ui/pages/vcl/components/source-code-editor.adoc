...
Чтобы проверять значения, введенные в компонент `SourceCodeEditor`, можно использовать xref:vcl/miscellaneous/validator.adoc[валидатор] во вложенном элементе `validators`.
