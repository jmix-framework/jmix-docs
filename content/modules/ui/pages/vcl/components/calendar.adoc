...
[TIP]
====
如需在 Jmix Studio 中定义 `dayNames` 或 `monthNames`，可以在界面 XML 或者 *Component Hierarchy* 面板中选择组件，然后点击 *Component Inspector* 面板的 xref:studio:screen-designer.adoc#component-inspector-add-button[Add] 按钮。
====
