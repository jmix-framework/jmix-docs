...
`TagField - 标签控件` 支持将选中的值作为标签展示。该组件基于 xref:vcl/components/suggestion-field.adoc[SuggestionField]，且功能相，最大的区别是，`TagField` 支持多选。另外还可以用 xref:vcl/components/tag-picker.adoc[TagPicker] 处理标签。
