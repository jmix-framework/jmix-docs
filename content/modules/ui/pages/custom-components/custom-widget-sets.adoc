...
The `excludePaths` and `includePaths` parameter/s accept the list of exclude and include patterns, respectively. For pattern rules see: https://docs.gradle.org/current/javadoc/org/gradle/api/tasks/util/PatternFilterable.html[^].
====
