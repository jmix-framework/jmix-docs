...
Screen descriptor is an XML file containing declarative definition of xref:ui:vcl.adoc[visual components], xref:ui:data-components.adoc[data components] and some screen parameters. For example, look at the XML descriptor of the edit screen:
