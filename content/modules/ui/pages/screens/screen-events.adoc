...
This section describes the screen lifecycle events that can be handled in controllers. To gain a general understanding of the sequence of events, see the <<diagrams,diagrams>> at the end of the section.
