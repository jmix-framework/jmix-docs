...
The diagram below shows the process of opening and closing a screen:

.Opening and closing a screen
image::screens/standard-screen-lifecycle.svg[align="center"]

The diagram below shows the process of opening an edit screen:

.Opening an edit screen for entity editing
image::screens/open-edit-screen.svg[align="center"]

The diagram below shows the process of commiting changes and closing an edit screen:

.Closing an edit screen with `windowCommitAndClose` action
