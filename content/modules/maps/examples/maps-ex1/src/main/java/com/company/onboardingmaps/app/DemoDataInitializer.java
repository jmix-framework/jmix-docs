package com.company.onboardingmaps.app;
...
public class DemoDataInitializer {
    ...
    private List<User> initUsers(List<Step> steps, List<Department> departments) {
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/" , "alice.png"));
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/" , "james.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/", "mary.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/", "linda.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/", "susan.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/onboardingmaps/demo/", "bob.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
