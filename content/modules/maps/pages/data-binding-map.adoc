...
The extent limits the view. You can adjust how the viewport is constrained by the extent using `mapView` extent constraint options. See xref:maps:map-component.adoc#extent-constraint-options[Extent Constraint Options].
