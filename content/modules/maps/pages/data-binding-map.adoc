...
The new `map` element will be added beneath the `formLayout` element in both the *Jmix UI* hierarchy panel and in the XML. Configure the `id`, `height` and `width` attributes as shown below.
