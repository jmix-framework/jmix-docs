...
Annotate the created property with the `@Geometry` annotation. It marks that the property contains geo-specific data, which is used while displaying an entity on a map.
