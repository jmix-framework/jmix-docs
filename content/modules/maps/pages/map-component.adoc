...
* `attribution` - information about copyrights and licences that need to be displayed on the map when using data from that source. For more details see https://openlayers.org/en/v8.1.0/apidoc/module-ol_source_Source-Source.html[Source^].
