...
Source for the loading tiles from an https://www.openstreetmap.org[OpenStreetMap^] tile server and from xref:maps:map-services.adoc#xyz-tiles[XYZ tile] services. For more details see https://openlayers.org/en/v8.1.0/apidoc/module-ol_source_OSM-OSM.html[OSM documentation^].
...
Source for tile data from xref:maps:map-services.adoc#web-map-service[WMS] (Web Map Service) servers. For more details see https://openlayers.org/en/v8.1.0/apidoc/module-ol_source_TileWMS-TileWMS.html[TileWMS documentation^].
...
Source for xref:maps:map-services.adoc#web-map-service[WMS] servers providing single, untiled images. For more details see https://openlayers.org/en/v8.1.0/apidoc/module-ol_source_ImageWMS-ImageWMS.html[ImageWMS documentation^].
