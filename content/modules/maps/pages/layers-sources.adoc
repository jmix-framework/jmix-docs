...
这个源的瓦片数据是从 https://www.openstreetmap.org[OpenStreetMap^] 瓦片服务和 xref:maps:map-services.adoc#xyz-tiles[XYZ tile] 服务加载。更多详情请参阅 https://openlayers.org/en/v8.2.0/apidoc/module-ol_source_OSM-OSM.html[OSM 文档^]。
