...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/maps/ex1/screen/salesperson/SalespersonBrowse.java[tags=popup-provider]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/maps/ex1/screen/order/OrderEdit.java[tags=font-icon]
----
+
image::font-icon.png[]
+
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/maps/ex1/screen/store/StoreEdit.java[tags=image-icon]
----
+
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/maps/ex1/screen/salesperson/SalespersonEdit.java[tags=div-icon]
----
+
image::div-icons.png[]
