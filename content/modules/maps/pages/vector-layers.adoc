...
To determine geometry style for geo-objects, use `setStyleProvider()` method. You can also perform this declaratively using the `@Install` annotation in the screen controller, 示例：
