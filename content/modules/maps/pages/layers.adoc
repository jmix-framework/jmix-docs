...
[source,xml,indent=0]
----
include::example$/ex1/src/main/resources/maps/ex1/screen/territory/territory-edit.xml[tags=territory-xml]
----
...
----
include::example$/ex1/src/main/java/maps/ex1/screen/territory/TerritoryEdit.java[tags=territory-java]
----
