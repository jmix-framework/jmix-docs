...
The Maps add-on enables developers to integrate interactive maps and geospatial features into web applications through the xref:flow-ui:vc/components/geoMap.adoc[GeoMap] component.
...
The add-on helps you enrich your application with visual representation and intuitive manipulation of spatial data. You can use a map provider that meets your needs.
...
* xref:flow-ui:vc/components/geoMap.adoc#view[Map View]. The Map add-on allows configuration of the map view, including center coordinates, zoom level, rotation angle, and projection definition.
