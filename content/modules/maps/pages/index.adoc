...
The Maps add-on provides the `GeoMap` component and features that enable developers to integrate interactive maps and geospatial features into their web applications.
