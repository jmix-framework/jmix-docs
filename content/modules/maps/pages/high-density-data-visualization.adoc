...
. Включите векторный слой в компонент xref:flow-ui:vc/components/geoMap.adoc[geoMap].
...
. Включите слой тепловой карты в компонент xref:flow-ui:vc/components/geoMap.adoc[geoMap]: выберите элемент `geoMap` на панели структуры *Jmix UI* или в XML-дескрипторе экрана, затем нажмите кнопку *Add* на панели инспектора. В выпадающем списке выберите *Layers → HeatmapLayer*.
+
