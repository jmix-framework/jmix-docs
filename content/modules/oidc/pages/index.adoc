...
与 2.8 之前版本兼容的开关。将此属性设置为 `false` 可在 REST API 中验证用户时忽略 xref:security:resource-roles.adoc#role-scope[角色作用域]。
...
与 2.8 之前版本兼容的开关。将此属性设置为 `false` 可在 UI 中验证用户时忽略 xref:security:resource-roles.adoc#role-scope[角色作用域]。
