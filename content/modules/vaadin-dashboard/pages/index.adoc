...
The xref:flow-ui:vc/components/dashboard.adoc[dashboard] UI component integrates the commercial https://vaadin.com/docs/v25/components/dashboard[Vaadin Dashboard^] into Jmix. It arranges content into a responsive grid of widgets that users can move, resize, and remove at runtime.
...
See xref:flow-ui:vc/components/dashboard.adoc[] for the description of the component, its elements, attributes, and Java API.
