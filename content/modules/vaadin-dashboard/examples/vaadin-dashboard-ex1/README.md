...
To start the application, use the **Vaadin Dashboard Ex1 Jmix Application** run configuration in your IDE, or run the following command in the project root directory:
