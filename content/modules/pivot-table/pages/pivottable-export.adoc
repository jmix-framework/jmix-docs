...
NOTE: 导出功能目前支持以下 xref:pivot-table:pivottable-component.adoc#using-renderers[渲染器] 类型：`TABLE`、`TABLE_BAR_CHART`、`HEATMAP`、`COL_HEATMAP` 和 `ROW_HEATMAP`。注意，不会导出单元格的颜色。
