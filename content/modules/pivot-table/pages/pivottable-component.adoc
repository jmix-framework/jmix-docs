...
image::pivot-table-basics.png[align="center", width="746"]
...
+
Create a class that implements the `JmixPivotTableItems` interface. Implement the main methods according to your custom data model and business logic. For example:
+
[source,java,indent=0]
----
