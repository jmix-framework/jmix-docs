...
Сводная таблица в xref:flow-ui:vc/components/pivotTable.adoc#ui-mode[режиме UI] будет отображена в новой вкладке. По умолчанию будут отображены все атрибуты, включенные в представление контейнера данных компонента, за исключением:
