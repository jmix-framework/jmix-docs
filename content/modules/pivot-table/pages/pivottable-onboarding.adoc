...
[source,xml,indent=0]
----
include::../examples/pivottable-onboarding/src/main/resources/com/company/pivottableonboarding/liquibase/changelog/2024/10/21-init-tip-info-data.xml[tags=onboarding-tip-info-data-changelog]
----
