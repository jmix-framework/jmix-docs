...
The xref:flow-ui:vc/components/pivotTable.adoc[PivotTable] component turns a data set into a summary table that users can manipulate through a two-dimensional drag-and-drop interface.
