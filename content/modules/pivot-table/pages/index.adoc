...
The PivotTable add-on provides a `PivotTable` component for Jmix UI with drag-and-drop functionality that enables turning a data set into a summary table and manipulating it with a 2D drag-and-drop UI.
