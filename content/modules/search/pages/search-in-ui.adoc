...
The `FullTextFilter` component works like xref:ui:vcl/components/property-filter.adoc[PropertyFilter].
...
You can set the proper strategy by using the `strategy` attribute, 示例：
