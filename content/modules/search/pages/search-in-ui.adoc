...
A search strategy defines how the search term is processed.
...
Additionally, you can create a custom search strategy. For that purpose, you need to create a new bean extending the `io.jmix.search.searching.SearchStrategy` interface and implement two methods:
