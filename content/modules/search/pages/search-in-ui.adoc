...
Дополнение Search предоставляет два UI-компонента: xref:flow-ui:vc/components/searchField.adoc[SearchField] и xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter].
...
Компоненты xref:flow-ui:vc/components/searchField.adoc[SearchField] и xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter] поддерживают следующие встроенные стратегии поиска:
...
После этого вы можете назначить вашу пользовательскую стратегию компоненту xref:flow-ui:vc/components/searchField.adoc[SearchField] или xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter], используя имя стратегии.
