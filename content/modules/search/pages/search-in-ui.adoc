...
The Search add-on provides two UI components: xref:flow-ui:vc/components/searchField.adoc[SearchField] and xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter].
...
The xref:flow-ui:vc/components/searchField.adoc[SearchField] and xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter] components support the following built-in search strategies:
...
After that, you can assign your custom strategy to the xref:flow-ui:vc/components/searchField.adoc[SearchField] or xref:flow-ui:vc/components/fullTextFilter.adoc[FullTextFilter] component using the strategy name.
