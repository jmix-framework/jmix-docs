...
Дополнение Search предоставляет полнотекстовый поиск в приложении. Оно позволяет настраивать индексацию сущностей и загруженных файлов, использовать API поиска и добавлять UI-компоненты xref:flow-ui:vc/components/searchField.adoc[searchField] и xref:flow-ui:vc/components/fullTextFilter.adoc[fullTextFilter]. Результаты поиска фильтруются на основе прав xref:security:index.adoc[доступа к данным] текущего пользователя.
