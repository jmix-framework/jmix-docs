...
xref:ai-chat:aiChat.adoc[aiChat] embeds it and drives it for you. Use it on its own to display a stored conversation, or to build your own chat out of the base components. The application can drive the list from end to end, as described in <<driving,Driving the Generation>>.

image::aichat-message-list-transcript.png[A conversation in the message list, align="center", width="672"]
...
See xref:ai-chat:localization.adoc#precedence[Precedence] for how the two levels combine.
