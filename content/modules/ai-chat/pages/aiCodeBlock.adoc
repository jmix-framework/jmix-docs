...
Its colors, icons, and geometry are exposed as custom properties, which can be set on the block, on a class, or on `:root` to reach every block in the application:
