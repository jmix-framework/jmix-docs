...
In the example above the wrap action keeps its standard labels. See xref:ai-chat:localization.adoc#precedence[Precedence] for how the two levels combine.
