...
Two more add-ons extend the reporting functionality:

* xref:vaadin-spreadsheet:index.adoc[] provides the spreadsheet component.
* xref:report-spreadsheet:index.adoc[] uses that component to open and edit XLS and XLSX reports inside the application. See xref:run-report.adoc#spreadsheet-viewer[Opening Reports within the Application].
