...
* `io.jmix.reportsflowui.action.RunListEntityReportAction` - 是一个 xref:ui:actions/standard-actions.adoc[standard action]，用来打印列表组件（`DataGrid`、`TreeDataGrid`）中的实体集合报表。
+
...
//TODO change examples for a new project
+
[source, java,indent=0]
----
