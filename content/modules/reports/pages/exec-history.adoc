...
`io.jmix.reportsui.action.list.ExecutionHistoryAction` – a xref:ui:actions/standard-actions.adoc[standard action] for displaying the report execution history. It should be defined for a `Button` or a list component (`Table`, `DataGrid`, etc.).
