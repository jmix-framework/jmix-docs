...
* *Entity selection screen* - optional view identifier, which will be used to select entity instances. If the view is not specified, selection will be made from a special view generic for all entities.
