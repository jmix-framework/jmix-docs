...
By default, SQL queries are executed on the main database. If you want to query an {manual_platform}/data_store.html[additional data store], set its name in the *Data store* field.
...
By default, JPQL queries use entities mapped to the main database. If you want to query entities from an {manual_platform}/data_store.html[additional data store], set its name in the *Data store* field.
