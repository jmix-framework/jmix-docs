...
[CAUTION]
====
As reporting engine always reloads entities in the *Entity* dataset, you cannot use it for new (not saved in DB) entity instances. You man use <<structure_groovy,Groovy dataset>> instead, passing entity as a parameter in the following way:
