...
[source, groovy]
----
def accountService = applicationContext.getBean(AccountService.class);
----
...
[source, json]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/json.groovy[]
----
--
...
[source, json]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/json.json[]
----
...
[source, groovy]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/formatter_for_dates.groovy[]
----
====
