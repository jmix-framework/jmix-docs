...
When creating or editing a report, *Report structure* tab will show as default:
...
// TODO finalize the params passed into Groovy script.
...
* `user` –  an object of the `org.springframework.security.core.userdetails` type used to get user information. For example:
+
[source, groovy]
----
