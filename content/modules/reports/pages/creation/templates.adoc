...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_grooveEngine1.html[]
----
...
* `getMessage()` helps you to get xref:localization:message-bundles.adoc#using-messages[localized messages] from message bundle or get localized enum values:
+
[source, groovy]
----
...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_html_6.html[]
----
...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_html_8.html[]
----
...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_html_9.html[]
----
...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_html_10.html[]
----
...
[source, html]
----
include::example$/ex1/src/main/resources/com/company/jmixreports/docrefs/examples_html_11.html[]
----
--
...
* by custom prefixes:
** You can use the `resource://` prefixes to reference to image files from `conf` directory or classpath. For example, the image `abc.jpg` hosted in the `resource\com\company\app\images` folder can be inserted like:
+
[source, html]
----
<img src="resource://com/company/app/images/abc.jpg" height="68" width="199" border="0" align="right"/>
----
