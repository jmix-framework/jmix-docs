...
[[template_chart]]
=== Chart Template
Chart output type is available if the application project xref:index.adoc#installation[installed] the xref:backoffice-ui:charts.adoc[*charts* component]. Resulting chart is displayed in the *Reports* -> *Show Charts* screen of your web application.
