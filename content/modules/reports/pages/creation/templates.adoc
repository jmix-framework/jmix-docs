...
+
* In the xref:configuration.adoc#jmix.reports.curlPath[jmix.reports.curlPath] application property in the `app.properties` file of the *core* module, specify the path to the command line *curl* tool.
