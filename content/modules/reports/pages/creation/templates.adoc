...
CSV templates support inline editing. You can edit the template directly in the *Report template* window and see the changes without having to re-upload the template file.
...
HTML templates support inline editing. You can edit the template directly in the *Report template* window and see the changes without having to re-upload the template file.
...
----
--
//TODO узнать про свойство jmix.reports.pdf-fonts-directory, не нашла его
...
//TODO сделать потом актуальную ссылку
