...
[source, plain]
----
GET http://localhost:8080/reports/v1/report
...
[source, plain]
----
GET http://localhost:8080/reports/v1/report/cb090350-2694-e2bb-f5d9-813daa8dc418
----
...
[source, plain]
----
POST http://localhost:8080/reports/v1/run/2dd27fbf-8830-416a-899f-339543f8f27a
----
...
[source, plain]
----
GET http://localhost:8080/reports/v1/group/4e083530-0b9c-11e1-9b41-6bdaa41bff94
----
...
[source, plain]
----
http://localhost:8080/reports/v1/docs/swagger.json
----
--
