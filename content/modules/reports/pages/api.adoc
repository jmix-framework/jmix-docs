...
Below we provide a formal description of some features specific to reporting. For more information on how to get an OAuth token and other REST API features, see xref:rest:index.adoc[REST API add-on documentation].
