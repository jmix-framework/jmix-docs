...
组件使用 Spring Security LDAP，提供开箱即用的安全配置，应用程序中集成组件便自动启用。LDAP 认证的流程和主要配置，请参阅 {spring-security-doc}/servlet/authentication/passwords/ldap.html[Spring Security 文档^]。
