...
Jmix BPM add-on turns Jmix into a platform for automating business processes. The add-on combines the power of the open-source xref:bpm:introduction.adoc#flowable-bpm[Flowable BPM engine] with intuitive design, monitoring, and management tools, providing a robust solution for process optimization.
