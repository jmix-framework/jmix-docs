...
In the *User groups* screen, you can manage groups of users to define them later as candidates for xref:bpm:bpmn/bpmn-user-task.adoc#candidates-by-user-groups[user task] assignees. A user can be a member of several groups.
