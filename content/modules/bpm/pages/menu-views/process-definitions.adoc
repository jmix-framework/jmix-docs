...
In this case, user tasks of suspended instances won’t be displayed in xref:menu-views/my-tasks.adoc[My tasks] view, all timers and jobs won’t be executed.
...
You can initiate xref:bpm:instance-migration.adoc[] from here. See the details in the corresponding section.
