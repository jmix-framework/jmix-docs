...
Во-первых, можно определить слушателя выполнения или слушателя задачи для определенного узла процесса. Подробнее см. в https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#execution-listener[документации Flowable^].
