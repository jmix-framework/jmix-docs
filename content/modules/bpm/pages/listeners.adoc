...
参考 https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs/#execution-listener[Flowable 文档^]。

[[task-listeners]]
== 任务监听器

参考 https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs/#task-listener[Flowable 文档^]。

[[spring-events-bpm]]
== BPM 的 Spring 事件

Jmix BPM 还引入了一组 Spring 应用事件，会发布下列事件：
