...
It represents the xref:bpm:getting-started.adoc#start-form[Start form]
...
It will be represented by the xref:bpm:getting-started.adoc#approval-form[Approval form]
...
It will be represented by the xref:bpm:getting-started.adoc#payment-form[Payment form] available only to accountants.
...
Now you can start and test your process, go to the xref:bpm:getting-started.adoc#testing-process[testing section].
