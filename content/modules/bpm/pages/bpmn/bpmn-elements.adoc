...
- xref:bpmn/bpmn-events.adoc[**Events**]: Represent something that happens during the process (that is, start, intermediate, end).
...
- xref:bpmn/bpmn-sequence-flow.adoc[**Sequence Flows**]: Indicate the order of activities in the process.
