...
Extension properties can be added to the task.

image::bpmn-service-task/extension-properties.png[,460]
...
<!--   . . .    -->
    <jmix:properties>
      <jmix:property name="color" value="red" />
    </jmix:properties>
  </extensionElements>
</serviceTask>
----
...
You can define execution listeners for the task. See xref:bpm:jmix-listeners.adoc#execution-listeners[Execution listeners].
