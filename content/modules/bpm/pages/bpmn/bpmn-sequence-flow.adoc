...
Additionally, sequence flows include also have a *Condition* property. For more information, see xref:bpmn/bpmn-gateways.adoc#gateways-conditions[Conditions] in the Exclusive Gateway section.

image::bpmn-sequence-flows/flow-properties.png[,463]
