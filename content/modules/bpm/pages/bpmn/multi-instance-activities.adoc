...
image::multi-instance/multi-instance-types.png[,463]
...
image::multi-instance/collection-source-user-task.png[,463]
...
image::sequence-flow-with-outcome-based-condition.png[,463]
...
See the xref:bpm:jmix-listeners.adoc#execution-listeners[Execution Listeners] section.
