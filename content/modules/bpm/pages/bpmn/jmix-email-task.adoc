= Email Sending Task
//todo -- Исправить баг!
// JST-5243 Email sending task -- not possible to set parameters
...
[NOTE]
====
Email sending task doesn't have multi-instance properties available. But you can use it within an embedded subprocess that is multi-instanced. See the xref:multi-instance.adoc[Multi-Instance] section.
====
