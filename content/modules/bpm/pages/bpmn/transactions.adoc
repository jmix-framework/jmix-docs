...
[NOTE]
====
To use this feature, set the *Asynchronous* property `true` for the corresponding element. This property is applicable to:

* xref:bpmn/bpmn-service-task.adoc[]
* xref:bpmn/bpmn-script-task.adoc[]
* xref:bpmn/bpmn-business-rule-task.adoc[]
* xref:bpmn/jmix-email-task.adoc[]
* xref:bpmn/bpmn-subprocesses.adoc#embedded-subprocess[Embedded subprocess]
* xref:bpmn/bpmn-subprocesses.adoc#call-activity[Call activity]
====
