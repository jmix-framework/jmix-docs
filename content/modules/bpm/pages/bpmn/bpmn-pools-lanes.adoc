...
Processes are often contained within a *swimming pool*, which can be further divided into *lanes*. Pools and lanes represent participants and responsibilities, adding structure and clarity to complex processes.
