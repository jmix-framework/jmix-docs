...
When you need a process form with a complex layout and behavior, use xref:flow-ui:index.adoc[Jmix views] instead of xref:bpm:input-dialog.adoc[input dialog] forms.
