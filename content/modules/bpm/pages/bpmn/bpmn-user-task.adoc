...
For xref:input-dialog.adoc[input dialog] process forms, outcomes are defined in the *Outcomes* section in the *BPMN Inspector* panel.
...
For xref:jmix-view.adoc#declare-task-outcomes[Jmix screen] forms, outcomes are defined in the screen controller.
