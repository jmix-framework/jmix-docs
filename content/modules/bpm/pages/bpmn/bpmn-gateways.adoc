...
Gateways have only general properties: an ID and a name.
...
Formally, the BPMN specification allows you to use one gateway in two roles, but this usage is not recommended.
