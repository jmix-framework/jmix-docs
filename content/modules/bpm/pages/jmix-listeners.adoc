...
You can define an execution listener for a particular process node. See https://www.flowable.com/open-source/docs/bpmn/ch07b-BPMN-Constructs#execution-listener[Flowable documentation^] for details.
