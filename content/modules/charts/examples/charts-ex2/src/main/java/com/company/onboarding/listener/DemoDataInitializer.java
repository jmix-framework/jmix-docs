...
public class DemoDataInitializer {
    ...
    private List<User> initUsers(List<Step> steps, List<Department> departments) {
        ...
        user.setBonus(20000F);
        user.setSalary(60000F);
        user.setHardSkills(3);
        user.setSoftSkills(2);
        user.setProblemSolving(4);
        user.setTeamwork(1);
        user.setAssessmentTotal(user.getTeamwork() + user.getHardSkills()
                + user.getProblemSolving() + user.getSoftSkills());
        ...
        user.setBonus(10000F);
        user.setSalary(80000F);
        user.setHardSkills(2);
        user.setSoftSkills(5);
        user.setProblemSolving(3);
        user.setTeamwork(4);
        user.setAssessmentTotal(user.getTeamwork() + user.getHardSkills()
                + user.getProblemSolving() + user.getSoftSkills());
        saveContext.saving(user);
        ...
        user.setBonus(27000F);
        user.setSalary(90000F);
        user.setHardSkills(5);
        user.setSoftSkills(4);
        user.setProblemSolving(2);
        user.setTeamwork(3);
        user.setAssessmentTotal(user.getTeamwork() + user.getHardSkills()
                + user.getProblemSolving() + user.getSoftSkills());
        saveContext.saving(user);
        ...
        user.setBonus(12000F);
        user.setSalary(100000F);
        user.setHardSkills(5);
        user.setSoftSkills(3);
        user.setProblemSolving(2);
        user.setTeamwork(4);
        user.setAssessmentTotal(user.getTeamwork() + user.getHardSkills()
                + user.getProblemSolving() + user.getSoftSkills());
        ...
        saveContext = new SaveContext();
        user = dataManager.create(User.class);
        user.setUsername("Robert Taylor");
        user.setPassword(createPassword());
        ...
        user.setBonus(10000F);
        user.setSalary(80000F);
        user.setHardSkills(1);
        user.setSoftSkills(3);
        user.setProblemSolving(5);
        user.setTeamwork(1);
        user.setAssessmentTotal(user.getTeamwork() + user.getHardSkills()
                + user.getProblemSolving() + user.getSoftSkills());
        saveContext.saving(user);
