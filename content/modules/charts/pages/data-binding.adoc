...
----
include::example$charts-ex1/src/main/java/com/company/demo/view/dataitems/EntityDataItemSample.java[tags=controller]
----
...
[source,java,indent=0]
----
include::example$charts-ex1/src/main/java/com/company/demo/view/dataitems/MapDataItemSample.java[tags=controller]
----
...
[source,java,indent=0]
----
include::example$charts-ex1/src/main/java/com/company/demo/view/dataitems/SimpleDataItemSample.java[tags=controller]
----
