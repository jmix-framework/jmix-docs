...
或者，可以直接从 GitHub 的 https://github.com/jmix-framework/jmix-onboarding[jmix-framework/jmix-onboarding^] 下载完整的示例程序源码。下载完成后，可以按照 xref:studio:project.adoc#opening-existing-project[打开已有项目] 的介绍在 Jmix Studio 中打开项目。
