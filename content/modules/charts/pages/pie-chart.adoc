...
Вы интегрируете компонент круговой диаграммы, чтобы отобразить распределение пользователей по различным статусам адаптации.
...
Круговая диаграмма должна отображать статусы адаптации в процентах. Данные не поступают напрямую из одного атрибута сущности и требуют агрегации на основе статусов пользователей.
...
Чтобы обработать данные при инициализации экрана, создайте `InitEvent`.
