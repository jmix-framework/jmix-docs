...
For your radar chart, you can use the `employeesDc` data container you've set in the xref:charts:bar-chart.adoc#data-binding[bar chart] section.
...
Once you complete these steps, your radar chart XML configuration will be as follows.
