...
The Jmix Charts add-on integrates https://echarts.apache.org[Apache ECharts^], an open-source JavaScript visualization library, into the xref:flow-ui:vc/components/chart.adoc[chart] component for creating a wide range of chart types.
