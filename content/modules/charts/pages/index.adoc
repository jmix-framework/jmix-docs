...
Дополнение Jmix Charts интегрирует https://echarts.apache.org[Apache ECharts^], JavaScript-библиотеку визуализации с открытым исходным кодом, в компонент xref:flow-ui:vc/components/chart.adoc[chart] для создания различных типов графиков.
