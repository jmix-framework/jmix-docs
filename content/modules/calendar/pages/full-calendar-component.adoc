...
The data provider that takes data from the provided list. It does not have XML definition but can be added programmatically.
...
The list data provider also reflects changes in the provided list using its API:
...
- `fetchEndDate` - the left border of visible date range in the `FullCalendar`.
