...
<div class="jmix-ui-live-demo-container">
    <a href="https://demo.jmix.ru/ui-samples/sample/calendar-url-query-parameters" class="live-demo-btn" target="_blank">ДЕМО</a>
</div>
++++
...
* xref:flow-ui:vc/components/fullCalendar.adoc#calendar-display-modes[Режим отображения календаря]. Это позволяет управлять тем, какой вид (например, день, неделя, месяц) отображается в календаре.
