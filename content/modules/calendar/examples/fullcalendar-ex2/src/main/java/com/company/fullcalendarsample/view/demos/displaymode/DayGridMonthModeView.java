...
@Route(value = "day-grid-month-mode-view", layout = MainView.class)
@ViewController(id = "DayGridMonthModeView")
@ViewDescriptor(path = "day-grid-month-mode-view.xml")
public class DayGridMonthModeView extends StandardView {
    @ViewComponent
    ...
    public void onInit(final InitEvent event) {
        ...
        SimpleCalendarEvent event2 = SimpleCalendarEvent.create()
                ...
                .withStartDateTime(LocalDate.now().plusDays(4), LocalTime.of(12, 30))
                .withEndDateTime(LocalDate.now().plusDays(4), LocalTime.of(15, 0))
                .build();
        SimpleCalendarEvent event3 = SimpleCalendarEvent.create()
                .withTitle("Inventory")
                .withAllDay(true)
                .withStartDateTime(LocalDate.now().plusDays(7), LocalTime.of(8, 0))
                .withEndDateTime(LocalDate.now().plusDays(9), LocalTime.of(17, 0))
                .build();
        SimpleCalendarEvent event4 = SimpleCalendarEvent.create()
                .withTitle("Meeting")
                .withStartDateTime(LocalDate.now().plusDays(14), LocalTime.of(13, 0))
                .withEndDateTime(LocalDate.now().plusDays(14), LocalTime.of(15, 0))
                .build();
