...
@Route(value = "list-week-mode-view", layout = MainView.class)
@ViewController(id = "ListWeekModeView")
@ViewDescriptor(path = "list-week-mode-view.xml")
public class ListWeekModeView extends StandardView {
