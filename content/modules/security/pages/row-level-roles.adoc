...
----
include::example$/ex1/src/main/java/security/ex1/security/constraints/LimitedAmountOrdersRole.java[tags=role-1;role-2]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/security/ex1/security/constraints/CreatedByMeOrdersRole.java[tags=role]
----
...
You can use parameters matching the `current_user_<attribute>` pattern. They will get values from the attributes of the currently logged in user. For example, the `current_user_username` parameter gets its value from the `username` attribute.
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/security/ex1/security/constraints/SameRegionRowsRole.java[tags=role]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/security/ex1/security/constraints/NonConfidentialRowsRole.java[tags=role]
----
