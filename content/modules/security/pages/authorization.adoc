...
- `UiShowScreenContext` - the context to check xref:security:resource-roles.adoc#screen-policy[screens policy].
- `FlowuiShowViewContext` - the context to check Flow UI views policy.
- `UiMenuContext` - the context to check xref:security:resource-roles.adoc#menu-policy[menu policy].
- `FlowuiMenuContext` - the context to check Flow UI menu policy.
