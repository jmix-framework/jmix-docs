...
- `FlowuiShowViewContext` - 用于检查 xref:security:resource-roles.adoc#view-policy[视图策略] 的 context。
- `FlowuiMenuContext` - 用于检查 xref:security:resource-roles.adoc#menu-policy[菜单策略] 的 context。
