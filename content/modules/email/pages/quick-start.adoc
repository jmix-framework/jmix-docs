...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/screen/newsitem/NewsItemEdit.java[tags=post-commit-event]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/screen/newsitem/NewsItemEdit.java[tags=send-by-email]
----
