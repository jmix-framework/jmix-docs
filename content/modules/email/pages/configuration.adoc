...
----
include::example$/ex1/src/main/java/sample/EmailSendingJob.java[tags=quartz]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/SampleEmailApplication.java[tags=quartz]
----
+
