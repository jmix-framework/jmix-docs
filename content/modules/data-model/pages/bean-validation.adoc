...
Bean Validation вызывается автоматически в xref:flow-ui:view-validation.adoc[экранах UI], когда пользователь отправляет введенную информацию, а также в универсальном xref:rest:index.adoc[REST API].
