...
Bean Validation is automatically invoked in xref:flow-ui:view-validation.adoc[UI views] when user submits data, and in the xref:rest:index.adoc[generic REST API].
