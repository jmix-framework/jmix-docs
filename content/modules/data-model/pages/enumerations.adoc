...
TIP: Use Studio enumeration designer to create Jmix enumerations.
...
----
include::example$/ex1/src/main/java/sample/entity/CustomerGrade.java[tags=enum]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/entity/Customer.java[tags=enum]
----
