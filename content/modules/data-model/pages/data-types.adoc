...
[source,properties]
----
include::example$/ex1/src/main/resources/sample/messages.properties[tags=format-strings]
----
...
----
include::example$/ex1/src/main/java/sample/datatype/YearDatatype.java[tags=datatype]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/entity/Model.java[tags=datatype]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/entity/GeoPoint.java[tags=datatype]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/datatype/GeoPointConverter.java[tags=datatype]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/datatype/GeoPointDatatype.java[tags=datatype]
----
...
[source,java,indent=0]
----
include::example$/ex1/src/main/java/sample/entity/Address.java[tags=datatype]
----
