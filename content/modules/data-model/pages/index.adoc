...
The data model is an essential part of any business application.
...
An entity can have references to other entities, even if they are from different data stores. It allows you to create an integral data model comprising data from multiple relational databases or even from sources of different nature, like NoSQL databases or REST APIs.
