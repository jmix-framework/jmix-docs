...
Вы можете отредактировать запрос прямо в XML или использовать конструктор JPQL, открытый по ссылке в атрибуте `query`, показанном на панели инспектора *Jmix UI*:
