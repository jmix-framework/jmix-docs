...
When you run Jmix Studio for the first time, a trial subscription for 28 days is activated. After it expires, you will be able to use the free version of Studio or purchase a commercial subscription.
...
// говорить ли здесь про возможность ввести ключ используя кнопку снизу слева?

Click on the *Sign In / Register* button.

//оставим этот скриншот?

image::project-setup/sign-in-your-account-dialog.png[align="center",width="710"]

* If you don't have a Jmix account, click on the *Register* link. Fill in the *First name*, *Last name*, *Email* and *Password* fields, accept the privacy policy and click on the *Register* button.
+
NOTE: The email address you entered will be used as your login email and the primary email address for your account.
+
...
[NOTE]
====
A trial subscription is issued automatically once by every new user. It allows you to evaluate the full capabilities of the Studio for 28 days.
