...
Switch to the *Editor and Preview* mode. Locate `hrManagerField` in the *Component Hierarchy* panel. The component will be selected in the preview, in the XML editor and in the *Component Inspector* panel in the lower right corner:
