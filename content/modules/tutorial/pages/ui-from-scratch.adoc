...
The new view will also be added to the main menu. Double-click on the *User Interface* -> *Main Menu* item in the *Jmix* tool window and switch to the *Structure* tab. Drag and drop `MyOnboardingScreen` to the top:
