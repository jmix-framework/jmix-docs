...
+
Go to your email account. Open the *Verify email* and click on the *Link to e-mail address verification* to finish the registration.
+
Go back to the IDE and click the *Log in* button.
