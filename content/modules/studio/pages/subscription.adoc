...
* Enterprise subscription includes the following add-ons:
...
* BPM subscription includes all above add-ons plus the xref:bpm:index.adoc[] add-on.

[NOTE]
====
The xref:vaadin-dashboard:index.adoc[] and xref:vaadin-spreadsheet:index.adoc[] add-ons integrate commercial Vaadin components. Using them requires an active https://vaadin.com/vaadin-for-jmix[Vaadin for Jmix^] subscription in addition to the Jmix subscription.
====
