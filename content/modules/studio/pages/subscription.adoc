...
The xref:studio:welcome.adoc[Welcome] screen also shows an account information:
...
The trial is a project demonstrating usage of the following Jmix commercial add-ons:
