...
image::snippet-window.png[align="center",width="641"]

可以从工具箱直接拖放代码段至你的代码中。代码段依赖代码中的上下文，因此，可能需要开发者提供某些参数。

下面的示例中，将 *Get localized message* 代码段拖放至代码中，会展示对话框要求提供消息键值。

image::snippet-example.png[align="center",width="922"]

代码段添加完成后如下所示：

image::snippet-example-result.png[align="center",width="667"]
...
image::snippet-query-result.png[align="center",width="798"]
