...
+
image::idea-gear.png[align="center",width="1218"]
+
. Нажмите `+` и добавьте один из репозиториев ночных сборок:
+
--
* Репозиторий Jmix: `\https://storage.jmix.ru/jmix-studio/nightly/updatePlugins-nightly.xml`
* Репозиторий JetBrains: `\https://plugins.jetbrains.com/plugins/jmix_nightly/list`
--
+
...
+
image::jmix-update.png[align="center",width="1218"]
+
