...
Studio provides a visual designer for creating xref:security:resource-roles.adoc[resource] and xref:security:row-level-roles.adoc[row-level] roles at design time.
