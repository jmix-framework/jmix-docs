...
类似的，如需添加 xref:security:row-level-roles.adoc#predicate-policy[断言策略]，可以点击顶部操作面板的 *Add Policy → Predicate Policy*。然后在 *Add Predicate Policy* 弹窗中，指定一个实体并选择需要创建的断言：
