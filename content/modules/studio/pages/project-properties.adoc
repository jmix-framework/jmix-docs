...
* The *Jmix version* field displays the version of the framework used in the project. The *Change* link located nearby allows you to xref:studio:project.adoc#upgrading-project[upgrade] the framework version. An automatic migration will be performed if required.
