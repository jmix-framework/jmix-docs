...
* *AI Agents Toolkit* 操作支持在项目中自动安装 https://github.com/jmix-framework/jmix-agent-toolkit[jmix-framework/jmix-agent-toolkit^] GitHub 仓库中的 Agent 技能、指令和 MCP 服务。支持以下 agent：Claude Code CLI、Codex、OpenCode、Junie。
