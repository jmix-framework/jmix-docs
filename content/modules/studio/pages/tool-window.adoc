...
* The *AI Agents Toolkit* action allows you to automatically install agent skills, instructions, and MCP servers from the https://github.com/jmix-framework/jmix-agent-guidelines[Jmix AI Agent Guidelines^] GitHub repository into the current project. It supports the following agents: Claude Code CLI, Codex, OpenCode, Junie.
