...
* Визард *AI Agents Toolkit* позволяет автоматически установить навыки агентов, инструкции и MCP-сервера из репозитория GitHub https://github.com/jmix-framework/jmix-agent-toolkit[jmix-framework/jmix-agent-toolkit^] для текущего проекта. Поддерживаются следующие агенты: Claude Code CLI, Codex, OpenCode, Junie.
