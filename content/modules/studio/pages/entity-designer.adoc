...
* *Designer* shows the entity structure. You can add entity's attributes, set an instance name, an xref:data-model:entities.adoc#inheritance[inheritance] strategy, and validations using a graphical interface instead of writing Java code.
+
