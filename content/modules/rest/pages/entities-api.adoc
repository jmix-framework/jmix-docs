...
include::entities-api/load-entities.adoc[]

include::entities-api/create-entities.adoc[]

include::entities-api/update-entities.adoc[]

include::entities-api/delete-entities.adoc[]
