...
You can use the API documentation to visualize, test, or generate client code for the REST API using tools like https://www.postman.com/[Postman^] or https://swagger.io/tools/[Swagger^].
...
TIP: A static version of the documentation is available online at {rest-api-open-api}/{latest-version}[^]
