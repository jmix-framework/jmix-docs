...
Defines a comma-separated list of URL https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/util/AntPathMatcher.html[patterns^], which should allow xref:authentication.adoc#anonymous-access[anonymous access].
