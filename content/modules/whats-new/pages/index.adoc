...
Новый компонент xref:flow-ui:vc/components/twinColumn.adoc[] позволяющий пользователям интуитивно выбирать элементы из списка или коллекции, перемещая их между двумя столбцами.
