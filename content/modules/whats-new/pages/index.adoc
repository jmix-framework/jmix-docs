...
* The BPM form wizard in Studio now supports creating forms for Start events and for entity instances instead of process variables. See the *Form template* and *Form type* dropdowns on the first step of the wizard.
