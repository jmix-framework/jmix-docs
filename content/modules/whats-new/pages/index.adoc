...
Страница настроек плагина *Jmx* теперь содержит кнопку *Invalidate cache*, которая позволяет удалить информацию, хранящуюся Studio в https://www.jetbrains.com/help/idea/directories-used-by-the-ide-to-store-settings-caches-plugins-and-logs.html#config-directory[каталоге конфигурации IDE^]. Очистка кэша может помочь, если у вас возникли проблемы с шаблонами проектов, созданием экранов или с дизайнером экранов.

Это действие также доступно в диалоговом окне команды *File* -> *Invalidate Caches*.
