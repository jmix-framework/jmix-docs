...
Also, you can access the log for a certain entity from any application screen. In the example below, an edit screen for the `Order` entity shows tables with the entity log content.
