...
The entity saving mechanism, as well as the xref:entity-log.adoc[entity log], is intended to track data changes at runtime. It has the following distinct features:
