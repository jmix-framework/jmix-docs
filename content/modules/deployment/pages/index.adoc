...
Данная глава описывает развертывание приложений, построенных с помощью Jmix. Она содержит информацию о базовых принципах и несколько конкретных сценариев.
...
NOTE: Все консольные команды, приведенные ниже, вызываются относительно корня проекта.
