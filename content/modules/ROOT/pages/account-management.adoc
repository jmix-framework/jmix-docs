...
. The purchase is successful. Click on the button and assign licenses in your subscription. Find more details about it in the <<subscription-management,Subscription Management>> section.
...
. After a successful purchase, the user can xref:studio:subscription.adoc#login-jmix-account[log in] to Jmix Studio.
