...
You should register Jmix account to use Jmix Studio or to manage your subscriptions. You can make it both on website or right xref:studio:subscription.adoc#login-jmix-account[in Studio].
...
. Go back to the browser and click the *Log in* button in the *Email Verification* form.
...
To get a xref:studio:subscription.adoc#rad-trial[RAD trial] subscription, you should xref:studio:subscription.adoc#login-jmix-account[log in] to the Jmix account via Jmix Studio. After that, a trial subscription for 28 days is activated.

[[enterprise-trial]]
=== Enterprise Trial

To get an xref:studio:subscription.adoc#enterprise-trial[Enterprise trial] subscription, visit your profile page at https://store.jmix.io/account[^] and click on the *Get Enterprise trial* button in the *Subscription* section.
...
A Company license is the standard licensing option for commercial and non-profit organizations. A Company license can be used by a single person within the organization.
...
. The license keys and instructions on how to use them will be sent to your email.
+
image::store/thank-you-page.png[align="center", width="1214"]
...
. To change the https://www.jmix.io/subscription-plans-and-prices/#plan[subscription plan^] or number of users in this subscription, click on the *Change number of users or plan* button. To cancel the automatic renewal of your subscription, click on the *Cancel renewal* button.
+
[[assign-license-key]]
...
* _Worker_ only sees his license key on the profile screen.
...
You can view invoice details before payment. Click on the *Download PDF* button.

To pay the invoice, click on the *Make payment* button.
