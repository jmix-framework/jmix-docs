...
If you are new to Jmix, xref:setup.adoc[set up] your development environment and go to the xref:getting-started:app.adoc[] section which will walk you through the creation of a small fully functioning application.
