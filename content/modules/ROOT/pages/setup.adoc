...
下载 JDK 17 或 21（例如， https://adoptium.net/temurin/releases/?version=17[Eclipse Temurin^]），然后根据安装包的提示进行安装。这对于从 IDEA 中运行应用程序已经足够。

NOTE: Jmix {page-component-display-version} 支持使用任何供应商提供的 Java 17 或 21 构建应用程序。但是由于 OpenJ9-based JDK 之前出现过问题，我们不推荐使用这个版本。
