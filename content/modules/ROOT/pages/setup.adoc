...
NOTE: With Jmix {page-component-display-version}, you can build applications using Java 21 or 25 from any vendor. However, we don't recommend an OpenJ9-based JDK due to the problems it has caused in the past.
