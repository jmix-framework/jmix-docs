...
Download JDK version 11 or 17 and install it to a directory suggested by the installer (for example, you can choose https://adoptium.net[Eclipse Temurin^] or https://bell-sw.com/pages/downloads[Liberica^] JDK). This is enough for creating and running applications from the IDE.

NOTE: Jmix {page-component-display-version} supports Java 11 and 17. Pay attention that OpenJ9 JVM is not supported.
