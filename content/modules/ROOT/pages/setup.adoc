...
NOTE: Jmix {page-component-display-version} 支持使用任何供应商提供的 Java 21 或 25 构建应用程序。但是由于 OpenJ9-based JDK 之前出现过问题，我们不推荐使用这个版本。
...
为了使 AI 代理能够有效地处理 Jmix 范式、架构和最佳实践，我们建议使用 https://github.com/jmix-framework/jmix-agent-guidelines[Jmix AI Agent 指南^]。指南提供：
