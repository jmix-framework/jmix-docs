...
NOTE: Jmix {page-component-display-version} поддерживает Java 21 или 25 от любого поставщика. Однако мы не рекомендуем использовать JDK, основанный на OpenJ9, так как в прошлом это вызывало проблемы.
...
Чтобы AI-агент эффективно работал с паттернами, архитектурой и лучшими практиками Jmix, мы рекомендуем использовать https://github.com/jmix-framework/jmix-agent-guidelines[Jmix AI Agent Guidelines^]. Это руководство предоставляет агентам:
