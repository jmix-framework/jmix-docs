...
Jmix not only provides a platform to build your applications. It also contains an ecosystem of add-ons that enrich the core functionality. Many add-ons are provided by the Jmix team, while others are contributions from the community.
...
The xref:modularity:creating-add-ons.adoc[] section describes how to create your own add-ons to modularize your applications and reuse functionality. To publish your open-source add-on to the Jmix marketplace, see xref:publish-add-on.adoc[].
