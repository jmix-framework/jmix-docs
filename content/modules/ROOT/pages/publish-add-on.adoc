...
3. Add a line with your maven coordinates and the correct version to `jmix-bom/build.gradle`:
+
        api 'my.new.jmix.addon:my-add-on:1.0.0'
        api 'my.new.jmix.addon:my-add-on-starter:1.0.0'

4. Create a PR with the target branch: `release_1_1` of the `jmix-framework/jmix` repository.
