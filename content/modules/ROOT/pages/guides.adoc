...
|xref:reports-guide:index.adoc[]
|Intermediate
|Explore practical examples of reports created using the Jmix Reports add-on.
...
|xref:observability-tracing-guide:index.adoc[]
|Advanced
|Learn how to implement distributed tracing across multiple Jmix applications using OpenTelemetry and Grafana Tempo.
|===
