...
The view XML, apart from UI components, also usually declares data containers. It enables declarative binding of UI components to entities and their attributes loaded into data containers:
