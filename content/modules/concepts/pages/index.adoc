...
The <<architecture, architecture overview>> diagrams ...

Our goal here is to give application developers more insights about Jmix capabilities and answer questions like "why does it work like this?". It will help making right choices, increase confidence and help using the platform more effectively.
