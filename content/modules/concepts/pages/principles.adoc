...
*Unified data model means that you don't have to create layers of data transfer objects (DTOs) and mappers to and from the persistence model. The UI controls and business logic can work directly with persistent entities.*
...
To better understand how Jmix provides a unified data model containing different elements, and what you can do with this model, please refer to the xref:features.adoc#data-model-and-metadata[Data Model and Metadata] section.
