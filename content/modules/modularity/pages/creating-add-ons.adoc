...
//Add-ons use the same `@Configuration` annotation on top-level

//Dependencies between add-ons are defined by dependencies between functional modules of add-ons used in the project.
