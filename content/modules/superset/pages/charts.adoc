...
The *Big Number* chart type is used to display a single, prominent metric or value. It is often used to highlight important numbers. In your dashboard, it will show the average salary of all employees.
