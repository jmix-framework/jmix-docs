...
To show created dashboard in Jmix, use the xref:flow-ui:vc/components/supersetDashboard.adoc[SupersetDashboard] component. It requires an embedded ID that you have previously generated in the dashboard settings.
