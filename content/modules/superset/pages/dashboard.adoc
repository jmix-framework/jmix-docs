...
Чтобы отобразить созданный дэшборд в Jmix-приложении, используйте компонент xref:flow-ui:vc/components/supersetDashboard.adoc[SupersetDashboard]. Он требует указания embedded ID, который вы ранее сгенерировали в настройках дэшборда.
