...
To show created dashboard in Jmix we can use xref:dashboard-component.adoc[SupersetDashboard] component. This component requires to specify an embedded ID that we previously enable in dashboard settings.
