...
Defines a timeout of background task that fetches guest token for xref:flow-ui:vc/components/supersetDashboard.adoc[SupersetDashboard] component in the default guest token provider.
