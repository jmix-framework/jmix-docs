...
Задает интервал выполнения фонового задания, которое извлекает гостевой токен для компонента xref:flow-ui:vc/components/supersetDashboard.adoc[SupersetDashboard] в провайдере гостевых токенов по умолчанию.
