...
WARNING: This configuration is used only for demonstration purpose and is not production ready. For production environment you should provide more precisely configuration with enabled CORS, HTTPS, etc.
