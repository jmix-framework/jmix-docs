...
To add the action to a table or data grid using Studio, open *Component Palette*, drag and drop *Facets* -> *Action* to the component, and select `showEntityInfo` in the *Add Action* dialog. The action will be added to the table, 示例：
