...
You can get a trial version of the add-on by visiting the add-on https://www.jmix.io/marketplace/business-calendars/[page^] on the Jmix Marketplace website.
