...
* xref:jmix-ui:data/data-containers.adoc[Containers] provide the thin layer between entities and data-aware visual components. Different types of containers hold either single instances or collections of entities.
* xref:jmix-ui:data/data-loaders.adoc[Loaders] load data to containers.
* xref:jmix-ui:data/data-context.adoc[DataContext] tracks changes in entities and saves changed instances upon request.
