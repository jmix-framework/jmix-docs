...
`DynamicAttributes` facet allows `DataGrid`, `Table` and `Form` components to show xref:dyn-attr:index.adoc[dynamic attributes] of entities loaded to linked data containers. It is available if your project
