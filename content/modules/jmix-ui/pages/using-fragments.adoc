...
This section explains how to define and use xref:jmix-ui:screens.adoc[screen fragments]. See also xref:jmix-ui:screens/screen-fragment-events.adoc[ScreenFragment Events] for how to handle fragment lifecycle events.
...
The same fragment can be included in the screen programmatically in a xref:jmix-ui:screens/screen-events.adoc#init-event[InitEvent] or xref:jmix-ui:screens/screen-events.adoc#after-init-event[AfterInitEvent] handler as follows:
