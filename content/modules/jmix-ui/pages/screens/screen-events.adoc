...
* `SHORTCUT` - the screen is closed by the keyboard shortcut defined in the xref:jmix-ui:app-properties.adoc#jmix.ui.screen.close-shortcut[jmix.ui.screen.close-shortcut] application property.
