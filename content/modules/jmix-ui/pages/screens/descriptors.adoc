...
Screen descriptor is an XML file containing declarative definition of xref:jmix-ui:vcl.adoc[visual components], xref:jmix-ui:data-components.adoc[data components] and some screen parameters. For example, look at the XML descriptor of the edit screen:
...
* `class` − a name of the xref:jmix-ui:screens/screen-controllers.adoc[controller].
...
----
+
* `actions` – defines the list of xref:jmix-ui:actions.adoc[actions] for the screen.
