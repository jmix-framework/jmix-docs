...
The main part of the screen is a Java or Groovy class called xref:jmix-ui:screens/screen-controllers.adoc[controller]. A layout of the screen is usually defined in an XML file called xref:jmix-ui:screens/descriptors.adoc[descriptor].
