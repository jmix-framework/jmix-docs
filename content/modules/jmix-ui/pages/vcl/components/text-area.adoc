...
`TextArea` mostly replicates the functionality of the xref:jmix-ui:vcl/components/text-field.adoc[] component.
...
Styling is identical to xref:jmix-ui:vcl/components/text-field.adoc[] component.
