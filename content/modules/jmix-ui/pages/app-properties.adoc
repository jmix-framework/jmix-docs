...
An identifier of a screen to be used as xref:jmix-ui:screens/root-screens.adoc#main-screen[main screen] of the application.
...
An identifier of a screen to be used as xref:jmix-ui:screens/root-screens.adoc#login-screen[login screen] of the application.
...
Defines the keyboard shortcut that closes the current xref:jmix-ui:screens.adoc[screen].
...
Defines the layout of the dialog displayed when a user attempts to close a xref:jmix-ui:screens.adoc[screen] with unsaved changes in `DataContext`.
