...
TIP: See also the xref:concepts:features.adoc#data-access[Feature Overview] section to learn about the ideas behind Jmix data access and its capabilities.
