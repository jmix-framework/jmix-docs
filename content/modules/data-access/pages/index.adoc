...
Another option for working with JPA entities is using JPA xref:entity-manager.adoc[EntityManager] directly. In this case, you bypass data access control, ignore cross-datastore references, and lose the integration with dynamic attributes.