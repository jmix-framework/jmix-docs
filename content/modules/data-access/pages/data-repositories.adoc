...
可以使用 `JmixDataRepositoryContext` 参数将 `io.jmix.core.querycondition.Condition` 和其他 Jmix 特定的参数传递给 Jmix Data Repositories。该参数适用于 Jmix Data Repositories 的标准方法和查询方法，支持在运行时动态更改。
