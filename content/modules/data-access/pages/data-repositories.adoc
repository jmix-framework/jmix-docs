...
You can apply the `io.jmix.core.repository.ApplyConstraints` annotation to your data repository. If the value of the annotation is `false`, the repository uses `UnconstrainedDataManager` instead of `DataManager`.
