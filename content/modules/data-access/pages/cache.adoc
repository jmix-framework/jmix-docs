...
* Using `cacheable = "true"` XML attribute or `setCacheable(true)` method of the `CollectionLoader` interface when working with xref:ui:data/data-loaders.adoc[data loaders].
