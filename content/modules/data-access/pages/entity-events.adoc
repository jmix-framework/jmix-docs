...
----
include::example$/data-access-ex1/src/main/java/com/company/demo/listener/CustomerEventListener.java[tags=import-customer;import-customer-grade;import-customer-grade-change;import-data-manager;import-id;import-entity-changed-event;import-autowired;import-event-listener;import-component;listener-bean;data-manager;before-commit]
----
<1> 确定变更类型。
<2> 确认属性修改。
<3> 获取变更实体的 id。
...
[source,java,indent=0]
----
include::example$/data-access-ex1/src/main/java/com/company/demo/listener/OrderLineEventListener.java[tags=import-order;import-order-line;import-data-manager;import-id;import-entity-changed-event;import-autowired;import-event-listener;import-component;entity-changed]
----
...
[source,java,indent=0]
----
include::example$/data-access-ex1/src/main/java/com/company/demo/listener/CustomerEventListener.java[tags=import-customer;import-customer-grade;import-data-manager;import-entity-changed-event;import-logger;import-logger-factory;import-autowired;import-component;import-transactional;import-transactional-event-listener;listener-bean;logger;data-manager;after-commit]
----
...
[source,java,indent=0]
----
include::example$/data-access-ex1/src/main/java/com/company/demo/listener/OrderEventListener.java[tags=import-order;import-entity-saving-event;import-event-listener;import-component;saving-event]
----
...
[CAUTION]
====
在 `EntitySavingEvent` 或 `EntityLoadingEvent` 监听器中，只能访问实体的本地属性。
...
[source,java,indent=0]
----
include::example$/data-access-ex1/src/main/java/com/company/demo/listener/CustomerEventListener.java[tags=import-encryption-service;import-customer;import-entity-loading-event;import-entity-saving-event;import-autowired;import-event-listener;import-component;listener-bean;encryption]
----
