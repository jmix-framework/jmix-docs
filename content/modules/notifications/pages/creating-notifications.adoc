...
[[ntf-editor]]
The notification editor appears after clicking the *Create new notification*.
...
* *Channels* - a way to send notifications. The *Email* channel is available in case the xref:email:index.adoc[Email] add-on is installed.  
** *In-app channel* - a user will receive the notification in the application interface.  
