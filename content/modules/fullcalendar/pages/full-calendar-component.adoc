...
In case of JPA or DTO entity, there is a <<ContainerDataProvider>> that wrapps an entity to the <<EntityCalendarEvent>>.

=== CalendarEvent

The base interface for events in calendar component.
...
This value is *exclusive*. For instance, an event with end property -
